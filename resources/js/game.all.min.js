...
this.glTarget=c.TEXTURE_2D,this.glFormat=c.RGBA,this.mipmaps=!1,this.glMinFilter=c.LINEAR,this.glMagFilter=c.LINEAR,this.glWrapS=c.CLAMP_TO_EDGE,this.glWrapT=c.CLAMP_TO_EDGE,this.isSrcMediaElement=void 0!==d.MediaElement&&b instanceof d.MediaElement,this._videoPrevUpdateTime=0,this.isSrcHTMLElement=void 0!==d.Element&&b instanceof d.Element&&!(b instanceof d.Graphics),this.isSrcP5Image=b instanceof d.Image,this.isSrcP5Graphics=b instanceof d.Graphics;var e=this._getTextureDataFromSource();return this.width=e.width,this.height=e.height,this.init(e),this},d.Texture.prototype._getTextureDataFromSource=function(){var a;return this.isSrcP5Image?a=this.src.canvas:(this.isSrcMediaElement||this.isSrcP5Graphics||this.isSrcHTMLElement)&&(a=this.src.elt),a},d.Texture.prototype.init=function(a){var b=this._renderer.GL;if(this.glTex=b.createTexture(),this.bindTexture(),b.texParameteri(b.TEXTURE_2D,b.TEXTURE_MAG_FILTER,this.glMagFilter),b.texParameteri(b.TEXTURE_2D,b.TEXTURE_MIN_FILTER,this.glMinFilter),b.texParameteri(b.TEXTURE_2D,b.TEXTURE_WRAP_S,this.glWrapS),b.texParameteri(b.TEXTURE_2D,b.TEXTURE_WRAP_T,this.glWrapT),0===this.width||0===this.height||this.isSrcMediaElement&&!this.src.loadedmetadata){var c=new Uint8Array([1,1,1,1]);b.texImage2D(this.glTarget,0,b.RGBA,1,1,0,this.glFormat,b.UNSIGNED_BYTE,c)}else b.texImage2D(this.glTarget,0,this.glFormat,this.glFormat,b.UNSIGNED_BYTE,a)},d.Texture.prototype.update=function(){var a=this.src;if(0!==a.width&&0!==a.height){var b=this._getTextureDataFromSource(),c=this._renderer.GL;if(b.width!==this.width||b.height!==this.height)this.width=b.width,this.height=b.height,this.bindTexture(),c.texImage2D(this.glTarget,0,this.glFormat,this.glFormat,c.UNSIGNED_BYTE,b),this.isSrcP5Image?a.setModified(!1):(this.isSrcMediaElement||this.isSrcHTMLElement)&&a.setModified(!0);else if(this.isSrcP5Image)a.isModified()&&(this.bindTexture(),c.texImage2D(this.glTarget,0,this.glFormat,this.glFormat,c.UNSIGNED_BYTE,b),a.setModified(!1));else if(this.isSrcMediaElement){var d=!1;a.isModified()?(d=!0,a.setModified(!1)):a.loadedmetadata&&this._videoPrevUpdateTime!==a.time()&&(this._videoPrevUpdateTime=a.time(),d=!0),d&&(this.bindTexture(),c.texImage2D(this.glTarget,0,this.glFormat,this.glFormat,c.UNSIGNED_BYTE,b))}else c.texImage2D(this.glTarget,0,this.glFormat,this.glFormat,c.UNSIGNED_BYTE,b)}},d.Texture.prototype.bindTexture=function(){return this._renderer.GL.bindTexture(this.glTarget,this.glTex),this},d.Texture.prototype.unbindTexture=function(){this._renderer.GL.bindTexture(this.glTarget,null)},b.exports=d.Texture},{"../core/core":21}],75:[function(a,b,c){"use strict";var d=a("../core/core");a("./p5.Geometry"),d.prototype.plane=function(a,b,c,e){void 0===a&&(a=50),void 0===b&&(b=a),void 0===c&&(c=1),void 0===e&&(e=1);var f="plane|"+c+"|"+e;if(!this._renderer.geometryInHash(f)){var g=function(){for(var a,b,c,e=0;e<=this.detailY;e++){b=e/this.detailY;for(var f=0;f<=this.detailX;f++)a=f/this.detailX,c=new d.Vector(a-.5,b-.5,0),this.vertices.push(c),this.uvs.push([a,b])}},h=new d.Geometry(c,e,g);h.computeFaces().computeNormals(),c<=1&&e<=1?(h._makeTriangleEdges(),this._renderer._edgesToVertices(h)):console.log("Cannot draw stroke on plane objects with more than 1 detailX or 1 detailY"),this._renderer.createBuffers(f,h)}this._renderer.drawBuffersScaled(f,a,b,0)},d.prototype.box=function(a,b,c,e,f){void 0===a&&(a=50),void 0===b&&(b=a),void 0===c&&(c=b),void 0===e&&(e=4),void 0===f&&(f=4);var g="box|"+e+"|"+f;if(!this._renderer.geometryInHash(g)){var h=function(){var a=[[0,4,2,6],[1,3,5,7],[0,1,4,5],[2,6,3,7],[0,2,1,3],[4,5,6,7]];this.strokeIndices=[[0,1],[1,3],[3,2],[6,7],[8,9],[9,11],[14,15],[16,17],[17,19],[18,19],[20,21],[22,23]];for(var b=0;b<a.length;b++){for(var c=a[b],e=4*b,f=0;f<4;f++){var g=c[f],h=new d.Vector((2*(1&g)-1)/2,((2&g)-1)/2,((4&g)/2-1)/2);this.vertices.push(h),this.uvs.push([1&f,(2&f)/2])}this.faces.push([e,e+1,e+2]),this.faces.push([e+2,e+1,e+3])}},i=new d.Geometry(e,f,h);i.computeNormals(),e<=4&&f<=4?(i._makeTriangleEdges(),this._renderer._edgesToVertices(i)):console.log("Cannot draw stroke on box objects with more than 4 detailX or 4 detailY"),this._renderer.createBuffers(g,i)}return this._renderer.drawBuffersScaled(g,a,b,c),this},d.prototype.sphere=function(a,b,c){return void 0===a&&(a=50),void 0===b&&(b=24),void 0===c&&(c=16),this.ellipsoid(a,a,a,b,c),this};var e=function(a,b,c,e,f,g,h){e=e<3?3:e,f=f<1?1:f,g=void 0===g||g,h=void 0===h||h;var i,j,k=(g?2:0)+(h?2:0),l=e+1,m=Math.atan2(a-b,c),n=g?-2:0,o=f+(h?2:0);for(i=n;i<=o;++i){var p,q=i/f,r=c*q;for(i<0?(r=0,q=1,p=a):i>f?(r=c,q=1,p=b):p=a+i/f*(b-a),-2!==i&&i!==f+2||(p=0,q=0),r-=c/2,j=0;j<l;++j)this.vertices.push(new d.Vector(Math.sin(j*Math.PI*2/e)*p,r,Math.cos(j*Math.PI*2/e)*p)),this.vertexNormals.push(new d.Vector(i<0||i>f?0:Math.sin(j*Math.PI*2/e)*Math.cos(m),i<0?-1:i>f?1:Math.sin(m),i<0||i>f?0:Math.cos(j*Math.PI*2/e)*Math.cos(m))),this.uvs.push([j/e,q])}for(i=0;i<f+k;++i)for(j=0;j<e;++j)this.faces.push([l*(i+0)+0+j,l*(i+0)+1+j,l*(i+1)+1+j]),this.faces.push([l*(i+0)+0+j,l*(i+1)+1+j,l*(i+1)+0+j])};d.prototype.cylinder=function(a,b,c,f){void 0===a&&(a=50),void 0===b&&(b=a),void 0===c&&(c=24),void 0===f&&(f=16);var g="cylinder|"+c+"|"+f;if(!this._renderer.geometryInHash(g)){var h=new d.Geometry(c,f);e.call(h,1,1,1,c,f,!0,!0),h.computeNormals(),c<=24&&f<=16?(h._makeTriangleEdges(),this._renderer._edgesToVertices(h)):console.log("Cannot draw stroke on cylinder objects with more than 24 detailX or 16 detailY"),this._renderer.createBuffers(g,h)}return this._renderer.drawBuffersScaled(g,a,a,b),this},d.prototype.cone=function(a,b,c,f){void 0===a&&(a=50),void 0===b&&(b=a),void 0===c&&(c=24),void 0===f&&(f=16);var g="cone|"+a+"|"+b+"|"+c+"|"+f;if(!this._renderer.geometryInHash(g)){var h=new d.Geometry(c,f);e.call(h,a,0,b,c,f,!0,!0),h.computeNormals(),c<=24&&f<=16?(h._makeTriangleEdges(),this._renderer._edgesToVertices(h)):console.log("Cannot draw stroke on cone objects with more than 24 detailX or 16 detailY"),this._renderer.createBuffers(g,h)}return this._renderer.drawBuffers(g),this},d.prototype.ellipsoid=function(a,b,c,e,f){void 0===a&&(a=50),void 0===b&&(b=a),void 0===c&&(c=a),void 0===e&&(e=24),void 0===f&&(f=16);var g="ellipsoid|"+e+"|"+f;if(!this._renderer.geometryInHash(g)){var h=function(){for(var a=0;a<=this.detailY;a++)for(var b=a/this.detailY,c=Math.PI*b-Math.PI/2,e=Math.cos(c),f=Math.sin(c),g=0;g<=this.detailX;g++){var h=g/this.detailX,i=2*Math.PI*h,j=Math.cos(i),k=Math.sin(i),l=new d.Vector(e*k,f,e*j);this.vertices.push(l),this.vertexNormals.push(l),this.uvs.push([h,b])}},i=new d.Geometry(e,f,h);i.computeFaces(),e<=24&&f<=24?(i._makeTriangleEdges(),this._renderer._edgesToVertices(i)):console.log("Cannot draw stroke on ellipsoids with more than 24 detailX or 24 detailY"),this._renderer.createBuffers(g,i)}return this._renderer.drawBuffersScaled(g,a,b,c),this},d.prototype.torus=function(a,b,c,e){if(void 0===a)a=50;else if(!a)return;if(void 0===b)b=10;else if(!b)return;void 0===c&&(c=24),void 0===e&&(e=16);var f=(b/a).toPrecision(4),g="torus|"+f+"|"+c+"|"+e;if(!this._renderer.geometryInHash(g)){var h=function(){for(var a=0;a<=this.detailY;a++)for(var b=a/this.detailY,c=2*Math.PI*b,e=Math.cos(c),g=Math.sin(c),h=1+f*e,i=0;i<=this.detailX;i++){var j=i/this.detailX,k=2*Math.PI*j,l=Math.cos(k),m=Math.sin(k),n=new d.Vector(h*l,h*m,f*g),o=new d.Vector(e*l,e*m,g);this.vertices.push(n),this.vertexNormals.push(o),this.uvs.push([j,b])}},i=new d.Geometry(c,e,h);i.computeFaces(),c<=24&&e<=16?(i._makeTriangleEdges(),this._renderer._edgesToVertices(i)):console.log("Cannot draw strokes on torus object with more than 24 detailX or 16 detailY"),this._renderer.createBuffers(g,i)}return this._renderer.drawBuffersScaled(g,a,a,a),this},d.RendererGL.prototype.point=function(a,b,c){return console.log("point not yet implemented in webgl"),this},d.RendererGL.prototype.triangle=function(a){var b=a[0],c=a[1],e=a[2],f=a[3],g=a[4],h=a[5],i="tri";if(!this.geometryInHash(i)){var j=function(){var a=[];a.push(new d.Vector(0,0,0)),a.push(new d.Vector(0,1,0)),a.push(new d.Vector(1,0,0)),this.strokeIndices=[[0,1],[1,2],[2,0]],this.vertices=a,this.faces=[[0,1,2]],this.uvs=[[0,0],[0,1],[1,1]]},k=new d.Geometry(1,1,j);k._makeTriangleEdges(),this._edgesToVertices(k),k.computeNormals(),this.createBuffers(i,k)}var l=this.uMVMatrix.copy();try{var m=new d.Matrix([e-b,f-c,0,0,g-b,h-c,0,0,0,0,1,0,b,c,0,1]).mult(this.uMVMatrix);this.uMVMatrix=m,this.drawBuffers(i)}finally{this.uMVMatrix=l}return this},d.RendererGL.prototype.ellipse=function(a){var b=a[0],c=a[1],e=a[2],f=a[3],g=a[4]||24,h="ellipse|"+g;if(!this.geometryInHash(h)){var i=function(){this.vertices.push(new d.Vector(.5,.5,0)),this.uvs.push([.5,.5]);for(var a=0;a<=this.detailX;a++){var b=a/this.detailX,c=2*Math.PI*b,e=.5+Math.cos(c)/2,f=.5+Math.sin(c)/2;this.vertices.push(new d.Vector(e,f,0)),this.uvs.push([e,f]),this.faces.push([0,(a+1)%this.detailX+1,a+1])}},j=new d.Geometry(g,1,i);j.computeNormals(),g<=50?(j._makeTriangleEdges(),this._edgesToVertices(j)):console.log("Cannot stroke ellipse with more than 50 detailX"),this.createBuffers(h,j)}var k=this.uMVMatrix.copy();try{this.uMVMatrix.translate([b,c,0]),this.uMVMatrix.scale(e,f,1),this.drawBuffers(h)}finally{this.uMVMatrix=k}return this},d.RendererGL.prototype.rect=function(a){var b=a[0],c=a[1],e=a[2],f=a[3],g=a[4]||24,h=a[5]||16,i="rect|"+g+"|"+h;if(!this.geometryInHash(i)){var j=function(){for(var a=0;a<=this.detailY;a++)for(var b=a/this.detailY,c=0;c<=this.detailX;c++){var e=c/this.detailX,f=new d.Vector(e,b,0);this.vertices.push(f),this.uvs.push([e,b])}},k=new d.Geometry(g,h,j);k.computeFaces().computeNormals()._makeTriangleEdges(),this._edgesToVertices(k),this.createBuffers(i,k)}var l=this.uMVMatrix.copy();try{this.uMVMatrix.translate([b,c,0]),this.uMVMatrix.scale(e,f,1),this.drawBuffers(i)}finally{this.uMVMatrix=l}return this},d.RendererGL.prototype.quad=function(a,b,c,e,f,g,h,i){var j="quad|"+a+"|"+b+"|"+c+"|"+e+"|"+f+"|"+g+"|"+h+"|"+i;if(!this.geometryInHash(j)){var k=function(){this.vertices.push(new d.Vector(a,b,0)),this.vertices.push(new d.Vector(c,e,0)),this.vertices.push(new d.Vector(f,g,0)),this.vertices.push(new d.Vector(h,i,0)),this.uvs.push([0,0],[1,0],[1,1],[0,1]),this.strokeIndices=[[0,1],[1,2],[2,3],[3,0]]},l=new d.Geometry(2,2,k);l.computeNormals()._makeTriangleEdges(),this._edgesToVertices(l),l.faces=[[0,1,2],[2,3,0]],this.createBuffers(j,l)}return this.drawBuffers(j),this},d.RendererGL.prototype.bezier=function(a,b,c,d,e,f,g,h,i,j,k,l){var m=this._pInst._bezierDetail||20;this.beginShape();for(var n=0;n<=m;n++){var o=Math.pow(1-n/m,3),p=n/m*3*Math.pow(1-n/m,2),q=3*Math.pow(n/m,2)*(1-n/m),r=Math.pow(n/m,3);this.vertex(a*o+d*p+g*q+j*r,b*o+e*p+h*q+k*r,c*o+f*p+i*q+l*r)}return this.endShape(),this},d.RendererGL.prototype.curve=function(a,b,c,d,e,f,g,h,i,j,k,l){var m=this._pInst._curveDetail;this.beginShape();for(var n=0;n<=m;n++){var o=.5*Math.pow(n/m,3),p=.5*Math.pow(n/m,2),q=n/m*.5,r=.5,s=o*(3*d-a-3*g+j)+p*(2*a-5*d+4*g-j)+q*(-a+g)+r*(2*d),t=o*(3*e-b-3*h+k)+p*(2*b-5*e+4*h-k)+q*(-b+h)+r*(2*e),u=o*(3*f-c-3*i+l)+p*(2*c-5*f+4*i-l)+q*(-c+i)+r*(2*f);this.vertex(s,t,u)}return this.endShape(),this},d.RendererGL.prototype.line=function(){return 6===arguments.length?(this.beginShape(),this.vertex(arguments[0],arguments[1],arguments[2]),this.vertex(arguments[3],arguments[4],arguments[5]),this.endShape()):4===arguments.length&&(this.beginShape(),this.vertex(arguments[0],arguments[1],0),this.vertex(arguments[2],arguments[3],0),this.endShape()),this},b.exports=d},{"../core/core":21,"./p5.Geometry":68}]},{},[12])(12)});console.log("### p5.collide ###"),p5.prototype._collideDebug=!1,p5.prototype.collideDebug=function(a){_collideDebug=a},p5.prototype.collideRectRect=function(a,b,c,d,e,f,g,h){return a+c>=e&&e+g>=a&&b+d>=f&&f+h>=b?!0:!1},p5.prototype.collideRectCircle=function(a,b,c,d,e,f,g){var h=e,i=f;a>e?h=a:e>a+c&&(h=a+c),b>f?i=b:f>b+d&&(i=b+d);var j=this.dist(e,f,h,i);return g/2>=j?!0:!1},p5.prototype.collideCircleCircle=function(a,b,c,d,e,f){return this.dist(a,b,d,e)<=c/2+f/2?!0:!1},p5.prototype.collidePointCircle=function(a,b,c,d,e){return this.dist(a,b,c,d)<=e/2?!0:!1},p5.prototype.collidePointRect=function(a,b,c,d,e,f){return a>=c&&c+e>=a&&b>=d&&d+f>=b?!0:!1},p5.prototype.collidePointLine=function(a,b,c,d,e,f,g){var h=this.dist(a,b,c,d),i=this.dist(a,b,e,f),j=this.dist(c,d,e,f);return void 0===g&&(g=.1),h+i>=j-g&&j+g>=h+i?!0:!1},p5.prototype.collideLineCircle=function(a,b,c,d,e,f,g){var h=this.collidePointCircle(a,b,e,f,g),i=this.collidePointCircle(c,d,e,f,g);if(h||i)return!0;var j=a-c,k=b-d,l=this.sqrt(j*j+k*k),m=((e-a)*(c-a)+(f-b)*(d-b))/this.pow(l,2),n=a+m*(c-a),o=b+m*(d-b),p=this.collidePointLine(n,o,a,b,c,d);if(!p)return!1;this._collideDebug&&this.ellipse(n,o,10,10),j=n-e,k=o-f;var q=this.sqrt(j*j+k*k);return g/2>=q?!0:!1},p5.prototype.collideLineLine=function(a,b,c,d,e,f,g,h,i){var j,k=((g-e)*(b-f)-(h-f)*(a-e))/((h-f)*(c-a)-(g-e)*(d-b)),l=((c-a)*(b-f)-(d-b)*(a-e))/((h-f)*(c-a)-(g-e)*(d-b));if(k>=0&&1>=k&&l>=0&&1>=l){if(this._collideDebug||i)var m=a+k*(c-a),n=b+k*(d-b);return this._collideDebug&&this.ellipse(m,n,10,10),i?j={x:m,y:n}:!0}return i?j={x:!1,y:!1}:!1},p5.prototype.collideLineRect=function(a,b,c,d,e,f,g,h,i){var j,k,l,m,n;return i?(j=this.collideLineLine(a,b,c,d,e,f,e,f+h,!0),k=this.collideLineLine(a,b,c,d,e+g,f,e+g,f+h,!0),l=this.collideLineLine(a,b,c,d,e,f,e+g,f,!0),m=this.collideLineLine(a,b,c,d,e,f+h,e+g,f+h,!0),n={left:j,right:k,top:l,bottom:m}):(j=this.collideLineLine(a,b,c,d,e,f,e,f+h),k=this.collideLineLine(a,b,c,d,e+g,f,e+g,f+h),l=this.collideLineLine(a,b,c,d,e,f,e+g,f),m=this.collideLineLine(a,b,c,d,e,f+h,e+g,f+h)),j||k||l||m?i?n:!0:!1},p5.prototype.collidePointPoly=function(a,b,c){for(var d=!1,e=0,f=0;f<c.length;f++){e=f+1,e==c.length&&(e=0);var g=c[f],h=c[e];(g.y>b&&h.y<b||g.y<b&&h.y>b)&&a<(h.x-g.x)*(b-g.y)/(h.y-g.y)+g.x&&(d=!d)}return d},p5.prototype.collideCirclePoly=function(a,b,c,d,e){void 0==e&&(e=!1);for(var f=0,g=0;g<d.length;g++){f=g+1,f==d.length&&(f=0);var h=d[g],i=d[f],j=this.collideLineCircle(h.x,h.y,i.x,i.y,a,b,c);if(j)return!0}if(1==e){var k=this.collidePointPoly(a,b,d);if(k)return!0}return!1},p5.prototype.collideRectPoly=function(a,b,c,d,e,f){void 0==f&&(f=!1);for(var g=0,h=0;h<e.length;h++){g=h+1,g==e.length&&(g=0);var i=e[h],j=e[g],k=this.collideLineRect(i.x,i.y,j.x,j.y,a,b,c,d);if(k)return!0;if(1==f){var l=this.collidePointPoly(a,b,e);if(l)return!0}}return!1},p5.prototype.collideLinePoly=function(a,b,c,d,e){for(var f=0,g=0;g<e.length;g++){f=g+1,f==e.length&&(f=0);var h=e[g].x,i=e[g].y,j=e[f].x,k=e[f].y,l=this.collideLineLine(a,b,c,d,h,i,j,k);if(l)return!0}return!1},p5.prototype.collidePolyPoly=function(a,b,c){void 0==c&&(c=!1);for(var d=0,e=0;e<a.length;e++){d=e+1,d==a.length&&(d=0);var f=a[e],g=a[d],h=this.collideLinePoly(f.x,f.y,g.x,g.y,b);if(h)return!0;if(1==c&&(h=this.collidePointPoly(b[0].x,b[0].y,a)))return!0}return!1},p5.prototype.collidePointTriangle=function(a,b,c,d,e,f,g,h){var i=this.abs((e-c)*(h-d)-(g-c)*(f-d)),j=this.abs((c-a)*(f-b)-(e-a)*(d-b)),k=this.abs((e-a)*(h-b)-(g-a)*(f-b)),l=this.abs((g-a)*(d-b)-(c-a)*(h-b));return j+k+l==i?!0:!1},p5.prototype.collidePointPoint=function(a,b,c,d,e){return void 0==e&&(e=0),this.dist(a,b,c,d)<=e?!0:!1},p5.prototype.collidePointArc=function(a,b,c,d,e,f,g,h){void 0==h&&(h=0);var i=this.createVector(a,b),j=this.createVector(c,d),k=this.createVector(e,0).rotate(f),l=i.copy().sub(j);if(i.dist(j)<=e+h){var m=k.dot(l),n=k.angleBetween(l);if(m>0&&g/2>=n&&n>=-g/2)return!0}return!1};/*
 JSON v3.3.2 | http://bestiejs.github.io/json3 | Copyright 2012-2014, Kit Cambridge | http://kit.mit-license.org  https://mths.be/wtf8 v1.0.0 by @mathias */
(function(k,d){"object"===typeof exports&&"object"===typeof module?module.exports=d():"function"===typeof define&&define.amd?define([],d):"object"===typeof exports?exports.io=d():k.io=d()})(this,function(){return function(k){function d(c){if(b[c])return b[c].exports;var a=b[c]={exports:{},id:c,loaded:!1};k[c].call(a.exports,a,a.exports,d);a.loaded=!0;return a.exports}var b={};d.m=k;d.c=b;d.p="";return d(0)}([function(k,d,b){function c(c,d){"object"===("undefined"===typeof c?"undefined":a(c))&&(d=
c,c=void 0);d=d||{};var b=f(c),m=b.source,e=b.id,l=b.path;l=r[e]&&l in r[e].nsps;d.forceNew||d["force new connection"]||!1===d.multiplex||l?(h("ignoring socket cache for %s",m),m=g(m,d)):(r[e]||(h("new io instance for %s",m),r[e]=g(m,d)),m=r[e]);if(b.query&&!d.query)d.query=b.query;else if(d&&"object"===a(d.query)){e=d;l=d.query;var p=[];for(q in l)l.hasOwnProperty(q)&&p.push(encodeURIComponent(q)+"="+encodeURIComponent(l[q]));var q=p.join("&");e.query=q}return m.socket(b.path,d)}var a="function"===
typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},f=b(1),l=b(7),g=b(17),h=b(3)("socket.io-client");k.exports=d=c;var r=d.managers={};d.protocol=l.protocol;d.connect=c;d.Manager=b(17);d.Socket=b(44)},function(k,d,b){(function(c){var a=b(2),f=b(3)("socket.io-client:url");k.exports=function(d,b){var h=d;b=b||c.location;null==d&&(d=b.protocol+"//"+b.host);"string"===
typeof d&&("/"===d.charAt(0)&&(d="/"===d.charAt(1)?b.protocol+d:b.host+d),/^(https?|wss?):\/\//.test(d)||(f("protocol-less url %s",d),d="undefined"!==typeof b?b.protocol+"//"+d:"https://"+d),f("parse %s",d),h=a(d));h.port||(/^(http|ws)$/.test(h.protocol)?h.port="80":/^(http|ws)s$/.test(h.protocol)&&(h.port="443"));h.path=h.path||"/";var g=-1!==h.host.indexOf(":")?"["+h.host+"]":h.host;h.id=h.protocol+"://"+g+":"+h.port;h.href=h.protocol+"://"+g+(b&&b.port===h.port?"":":"+h.port);return h}}).call(d,
function(){return this}())},function(k,d){var b=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,c="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");k.exports=function(a){var d=a,l=a.indexOf("["),g=a.indexOf("]");-1!=l&&-1!=g&&(a=a.substring(0,l)+a.substring(l,
g).replace(/:/g,";")+a.substring(g,a.length));a=b.exec(a||"");for(var h={},r=14;r--;)h[c[r]]=a[r]||"";-1!=l&&-1!=g&&(h.source=d,h.host=h.host.substring(1,h.host.length-1).replace(/;/g,":"),h.authority=h.authority.replace("[","").replace("]","").replace(/;/g,":"),h.ipv6uri=!0);return h}},function(k,d,b){(function(c){function a(){try{return d.storage.debug}catch(g){}if("undefined"!==typeof c&&"env"in c)return c.env.DEBUG}d=k.exports=b(5);d.log=function(){return"object"===typeof console&&console.log&&
Function.prototype.apply.call(console.log,console,arguments)};d.formatArgs=function(){var a=arguments,c=this.useColors;a[0]=(c?"%c":"")+this.namespace+(c?" %c":" ")+a[0]+(c?"%c ":" ")+"+"+d.humanize(this.diff);if(!c)return a;c="color: "+this.color;a=[a[0],c,"color: inherit"].concat(Array.prototype.slice.call(a,1));var f=0,b=0;a[0].replace(/%[a-z%]/g,function(a){"%%"!==a&&(f++,"%c"===a&&(b=f))});a.splice(b,0,c);return a};d.save=function(a){try{null==a?d.storage.removeItem("debug"):d.storage.debug=
a}catch(h){}};d.load=a;d.useColors=function(){return"undefined"!==typeof document&&"WebkitAppearance"in document.documentElement.style||window.console&&(console.firebug||console.exception&&console.table)||navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/)&&31<=parseInt(RegExp.$1,10)};var f=d;if("undefined"!=typeof chrome&&"undefined"!=typeof chrome.storage)var l=chrome.storage.local;else a:{try{l=window.localStorage;break a}catch(g){}l=void 0}f.storage=l;d.colors="lightseagreen forestgreen goldenrod dodgerblue darkorchid crimson".split(" ");
d.formatters.j=function(a){try{return JSON.stringify(a)}catch(h){return"[UnexpectedJSONParseError]: "+h.message}};d.enable(a())}).call(d,b(4))},function(k,d){function b(){throw Error("setTimeout has not been defined");}function c(){throw Error("clearTimeout has not been defined");}function a(e){if(q===setTimeout)return setTimeout(e,0);if((q===b||!q)&&setTimeout)return q=setTimeout,setTimeout(e,0);try{return q(e,0)}catch(x){try{return q.call(null,e,0)}catch(I){return q.call(this,e,0)}}}function f(e){if(n===
clearTimeout)return clearTimeout(e);if((n===c||!n)&&clearTimeout)return n=clearTimeout,clearTimeout(e);try{return n(e)}catch(x){try{return n.call(null,e)}catch(I){return n.call(this,e)}}}function l(){e&&t&&(e=!1,t.length?m=t.concat(m):y=-1,m.length&&g())}function g(){if(!e){var c=a(l);e=!0;for(var d=m.length;d;){t=m;for(m=[];++y<d;)t&&t[y].run();y=-1;d=m.length}t=null;e=!1;f(c)}}function h(e,a){this.fun=e;this.array=a}function r(){}var p=k.exports={};try{var q="function"===typeof setTimeout?setTimeout:
b}catch(v){q=b}try{var n="function"===typeof clearTimeout?clearTimeout:c}catch(v){n=c}var m=[],e=!1,t,y=-1;p.nextTick=function(c){var d=Array(arguments.length-1);if(1<arguments.length)for(var f=1;f<arguments.length;f++)d[f-1]=arguments[f];m.push(new h(c,d));1!==m.length||e||a(g)};h.prototype.run=function(){this.fun.apply(null,this.array)};p.title="browser";p.browser=!0;p.env={};p.argv=[];p.version="";p.versions={};p.on=r;p.addListener=r;p.once=r;p.off=r;p.removeListener=r;p.removeAllListeners=r;p.emit=
r;p.binding=function(e){throw Error("process.binding is not supported");};p.cwd=function(){return"/"};p.chdir=function(e){throw Error("process.chdir is not supported");};p.umask=function(){return 0}},function(k,d,b){function c(c){function b(){}function h(){var c=+new Date;h.diff=c-(f||c);h.prev=f;f=h.curr=c;null==h.useColors&&(h.useColors=d.useColors());null==h.color&&h.useColors&&(h.color=d.colors[a++%d.colors.length]);var b=Array(arguments.length);for(c=0;c<b.length;c++)b[c]=arguments[c];b[0]=d.coerce(b[0]);
"string"!==typeof b[0]&&(b=["%o"].concat(b));var l=0;b[0]=b[0].replace(/%([a-z%])/g,function(a,e){if("%%"===a)return a;l++;var c=d.formatters[e];"function"===typeof c&&(a=c.call(h,b[l]),b.splice(l,1),l--);return a});b=d.formatArgs.apply(h,b);(h.log||d.log||console.log.bind(console)).apply(h,b)}b.enabled=!1;h.enabled=!0;var l=d.enabled(c)?h:b;l.namespace=c;return l}d=k.exports=c.debug=c;d.coerce=function(a){return a instanceof Error?a.stack||a.message:a};d.disable=function(){d.enable("")};d.enable=
function(a){d.save(a);for(var c=(a||"").split(/[\s,]+/),f=c.length,b=0;b<f;b++)c[b]&&(a=c[b].replace(/[\\^$+?.()|[\]{}]/g,"\\$&").replace(/\*/g,".*?"),"-"===a[0]?d.skips.push(new RegExp("^"+a.substr(1)+"$")):d.names.push(new RegExp("^"+a+"$")))};d.enabled=function(a){var c;var f=0;for(c=d.skips.length;f<c;f++)if(d.skips[f].test(a))return!1;f=0;for(c=d.names.length;f<c;f++)if(d.names[f].test(a))return!0;return!1};d.humanize=b(6);d.names=[];d.skips=[];d.formatters={};var a=0,f},function(k,d){function b(a){a=
String(a);if(!(1E4<a.length)&&(a=/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(a))){var c=parseFloat(a[1]);switch((a[2]||"ms").toLowerCase()){case "years":case "year":case "yrs":case "yr":case "y":return 315576E5*c;case "days":case "day":case "d":return 864E5*c;case "hours":case "hour":case "hrs":case "hr":case "h":return 36E5*c;case "minutes":case "minute":case "mins":case "min":case "m":return 6E4*c;case "seconds":case "second":case "secs":case "sec":case "s":return 1E3*
c;case "milliseconds":case "millisecond":case "msecs":case "msec":case "ms":return c}}}function c(a,c,d){if(!(a<c))return a<1.5*c?Math.floor(a/c)+" "+d:Math.ceil(a/c)+" "+d+"s"}k.exports=function(a,d){d=d||{};var f=typeof a;if("string"===f&&0<a.length)return b(a);if("number"===f&&!1===isNaN(a))return d["long"]?c(a,864E5,"day")||c(a,36E5,"hour")||c(a,6E4,"minute")||c(a,1E3,"second")||a+" ms":864E5<=a?Math.round(a/864E5)+"d":36E5<=a?Math.round(a/36E5)+"h":6E4<=a?Math.round(a/6E4)+"m":1E3<=a?Math.round(a/
1E3)+"s":a+"ms";throw Error("val is not a non-empty string or a valid number. val="+JSON.stringify(a));}},function(k,d,b){function c(){}function a(a){var c=!1;var e=""+a.type;if(d.BINARY_EVENT==a.type||d.BINARY_ACK==a.type)e+=a.attachments,e+="-";a.nsp&&"/"!=a.nsp&&(c=!0,e+=a.nsp);null!=a.id&&(c&&(e+=",",c=!1),e+=a.id);null!=a.data&&(c&&(e+=","),e+=r.stringify(a.data));h("encoded %j as %s",a,e);return e}function f(c,m){p.removeBlobs(c,function(e){var c=p.deconstructPacket(e);e=a(c.packet);c=c.buffers;
c.unshift(e);m(c)})}function l(){this.reconstructor=null}function g(a){this.reconPack=a;this.buffers=[]}var h=b(8)("socket.io-parser"),r=b(11);k=b(13);var p=b(14),q=b(16);d.protocol=4;d.types="CONNECT DISCONNECT EVENT ACK ERROR BINARY_EVENT BINARY_ACK".split(" ");d.CONNECT=0;d.DISCONNECT=1;d.EVENT=2;d.ACK=3;d.ERROR=4;d.BINARY_EVENT=5;d.BINARY_ACK=6;d.Encoder=c;d.Decoder=l;c.prototype.encode=function(c,m){h("encoding packet %j",c);if(d.BINARY_EVENT==c.type||d.BINARY_ACK==c.type)f(c,m);else{var e=a(c);
m([e])}};k(l.prototype);l.prototype.add=function(a){if("string"==typeof a){var c={},e=0;c.type=Number(a.charAt(0));if(null==d.types[c.type])a={type:d.ERROR,data:"parser error"};else{if(d.BINARY_EVENT==c.type||d.BINARY_ACK==c.type){for(var b="";"-"!=a.charAt(++e)&&(b+=a.charAt(e),e!=a.length););if(b!=Number(b)||"-"!=a.charAt(e))throw Error("Illegal attachments");c.attachments=Number(b)}if("/"==a.charAt(e+1))for(c.nsp="";++e;){b=a.charAt(e);if(","==b)break;c.nsp+=b;if(e==a.length)break}else c.nsp="/";
b=a.charAt(e+1);if(""!==b&&Number(b)==b){for(c.id="";++e;){b=a.charAt(e);if(null==b||Number(b)!=b){--e;break}c.id+=a.charAt(e);if(e==a.length)break}c.id=Number(c.id)}if(a.charAt(++e)){e=a.substr(e);try{c.data=r.parse(e)}catch(y){c={type:d.ERROR,data:"parser error"}}}h("decoded %s as %j",a,c);a=c}d.BINARY_EVENT==a.type||d.BINARY_ACK==a.type?(this.reconstructor=new g(a),0===this.reconstructor.reconPack.attachments&&this.emit("decoded",a)):this.emit("decoded",a)}else if(q(a)||a.base64)if(this.reconstructor){if(a=
this.reconstructor.takeBinaryData(a))this.reconstructor=null,this.emit("decoded",a)}else throw Error("got binary data when not reconstructing a packet");else throw Error("Unknown type: "+a);};l.prototype.destroy=function(){this.reconstructor&&this.reconstructor.finishedReconstruction()};g.prototype.takeBinaryData=function(a){this.buffers.push(a);return this.buffers.length==this.reconPack.attachments?(a=p.reconstructPacket(this.reconPack,this.buffers),this.finishedReconstruction(),a):null};g.prototype.finishedReconstruction=
function(){this.reconPack=null;this.buffers=[]}},function(k,d,b){function c(){try{var a=d.storage.debug}catch(l){}return a}d=k.exports=b(9);d.log=function(){return"object"===typeof console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)};d.formatArgs=function(){var a=arguments,c=this.useColors;a[0]=(c?"%c":"")+this.namespace+(c?" %c":" ")+a[0]+(c?"%c ":" ")+"+"+d.humanize(this.diff);if(!c)return a;c="color: "+this.color;a=[a[0],c,"color: inherit"].concat(Array.prototype.slice.call(a,
1));var b=0,h=0;a[0].replace(/%[a-z%]/g,function(a){"%%"!==a&&(b++,"%c"===a&&(h=b))});a.splice(h,0,c);return a};d.save=function(a){try{null==a?d.storage.removeItem("debug"):d.storage.debug=a}catch(l){}};d.load=c;d.useColors=function(){return"WebkitAppearance"in document.documentElement.style||window.console&&(console.firebug||console.exception&&console.table)||navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/)&&31<=parseInt(RegExp.$1,10)};if("undefined"!=typeof chrome&&"undefined"!=typeof chrome.storage)var a=
chrome.storage.local;else a:{try{a=window.localStorage;break a}catch(f){}a=void 0}d.storage=a;d.colors="lightseagreen forestgreen goldenrod dodgerblue darkorchid crimson".split(" ");d.formatters.j=function(a){return JSON.stringify(a)};d.enable(c())},function(k,d,b){d=k.exports=function(b){function f(){}function g(){var b=+new Date;g.diff=b-(a||b);g.prev=a;a=g.curr=b;null==g.useColors&&(g.useColors=d.useColors());null==g.color&&g.useColors&&(g.color=d.colors[c++%d.colors.length]);var f=Array.prototype.slice.call(arguments);
f[0]=d.coerce(f[0]);"string"!==typeof f[0]&&(f=["%o"].concat(f));var h=0;f[0]=f[0].replace(/%([a-z%])/g,function(a,c){if("%%"===a)return a;h++;var e=d.formatters[c];"function"===typeof e&&(a=e.call(g,f[h]),f.splice(h,1),h--);return a});"function"===typeof d.formatArgs&&(f=d.formatArgs.apply(g,f));(g.log||d.log||console.log.bind(console)).apply(g,f)}f.enabled=!1;g.enabled=!0;var h=d.enabled(b)?g:f;h.namespace=b;return h};d.coerce=function(a){return a instanceof Error?a.stack||a.message:a};d.disable=
function(){d.enable("")};d.enable=function(a){d.save(a);for(var c=(a||"").split(/[\s,]+/),b=c.length,f=0;f<b;f++)c[f]&&(a=c[f].replace(/\*/g,".*?"),"-"===a[0]?d.skips.push(new RegExp("^"+a.substr(1)+"$")):d.names.push(new RegExp("^"+a+"$")))};d.enabled=function(a){var c;var b=0;for(c=d.skips.length;b<c;b++)if(d.skips[b].test(a))return!1;b=0;for(c=d.names.length;b<c;b++)if(d.names[b].test(a))return!0;return!1};d.humanize=b(10);d.names=[];d.skips=[];d.formatters={};var c=0,a},function(k,d){function b(a){a=
""+a;if(!(1E4<a.length)&&(a=/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(a))){var c=parseFloat(a[1]);switch((a[2]||"ms").toLowerCase()){case "years":case "year":case "yrs":case "yr":case "y":return 315576E5*c;case "days":case "day":case "d":return 864E5*c;case "hours":case "hour":case "hrs":case "hr":case "h":return 36E5*c;case "minutes":case "minute":case "mins":case "min":case "m":return 6E4*c;case "seconds":case "second":case "secs":case "sec":case "s":return 1E3*
c;case "milliseconds":case "millisecond":case "msecs":case "msec":case "ms":return c}}}function c(a,c,b){if(!(a<c))return a<1.5*c?Math.floor(a/c)+" "+b:Math.ceil(a/c)+" "+b+"s"}k.exports=function(a,d){d=d||{};return"string"==typeof a?b(a):d["long"]?c(a,864E5,"day")||c(a,36E5,"hour")||c(a,6E4,"minute")||c(a,1E3,"second")||a+" ms":864E5<=a?Math.round(a/864E5)+"d":36E5<=a?Math.round(a/36E5)+"h":6E4<=a?Math.round(a/6E4)+"m":1E3<=a?Math.round(a/1E3)+"s":a+"ms"}},function(k,d,b){(function(c,a){(function(){function b(a,
c){function e(a){if(e[a]!==z)return e[a];if("bug-string-char-index"==a)var b=!1;else if("json"==a)b=e("json-stringify")&&e("json-parse");else{var f;if("json-stringify"==a){b=c.stringify;var h="function"==typeof b&&A;if(h){(f=function(){return 1}).toJSON=f;try{h="0"===b(0)&&"0"===b(new d)&&'""'==b(new m)&&b(q)===z&&b(z)===z&&b()===z&&"1"===b(f)&&"[1]"==b([f])&&"[null]"==b([z])&&"null"==b(null)&&"[null,null,null]"==b([z,q,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==b({a:[f,!0,!1,null,
"\x00\b\n\f\r\t"]})&&"1"===b(null,f)&&"[\n 1,\n 2\n]"==b([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==b(new g(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==b(new g(864E13))&&'"-000001-01-01T00:00:00.000Z"'==b(new g(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==b(new g(-1))}catch(J){h=!1}}b=h}if("json-parse"==a){b=c.parse;if("function"==typeof b)try{if(0===b("0")&&!b(!1)){f=b('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var t=5==f.a.length&&1===f.a[0];if(t){try{t=!b('"\t"')}catch(J){}if(t)try{t=
1!==b("01")}catch(J){}if(t)try{t=1!==b("1.")}catch(J){}}}}catch(J){t=!1}b=t}}return e[a]=!!b}a||(a=h.Object());c||(c=h.Object());var d=a.Number||h.Number,m=a.String||h.String,f=a.Object||h.Object,g=a.Date||h.Date,t=a.SyntaxError||h.SyntaxError,p=a.TypeError||h.TypeError,n=a.Math||h.Math,r=a.JSON||h.JSON;"object"==typeof r&&r&&(c.stringify=r.stringify,c.parse=r.parse);f=f.prototype;var q=f.toString,k,z,A=new g(-0xc782b5b800cec);try{A=-109252==A.getUTCFullYear()&&0===A.getUTCMonth()&&1===A.getUTCDate()&&
10==A.getUTCHours()&&37==A.getUTCMinutes()&&6==A.getUTCSeconds()&&708==A.getUTCMilliseconds()}catch(V){}if(!e("json")){var F=e("bug-string-char-index");if(!A)var B=n.floor,R=[0,31,59,90,120,151,181,212,243,273,304,334],G=function(a,c){return R[c]+365*(a-1970)+B((a-1969+(c=+(1<c)))/4)-B((a-1901+c)/100)+B((a-1601+c)/400)};(k=f.hasOwnProperty)||(k=function(a){var c={};if((c.__proto__=null,c.__proto__={toString:1},c).toString!=q)k=function(a){var c=this.__proto__;a=a in(this.__proto__=null,this);this.__proto__=
c;return a};else{var e=c.constructor;k=function(a){var c=(this.constructor||e).prototype;return a in this&&!(a in c&&this[a]===c[a])}}c=null;return k.call(this,a)});var H=function(a,c){var e=0,b,d;(b=function(){this.valueOf=0}).prototype.valueOf=0;var m=new b;for(d in m)k.call(m,d)&&e++;b=m=null;e?H=2==e?function(a,c){var e={},b="[object Function]"==q.call(a),d;for(d in a)b&&"prototype"==d||k.call(e,d)||!(e[d]=1)||!k.call(a,d)||c(d)}:function(a,c){var e="[object Function]"==q.call(a),b,d;for(b in a)e&&
"prototype"==b||!k.call(a,b)||(d="constructor"===b)||c(b);(d||k.call(a,b="constructor"))&&c(b)}:(m="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),H=function(a,c){var e="[object Function]"==q.call(a),b,d=!e&&"function"!=typeof a.constructor&&l[typeof a.hasOwnProperty]&&a.hasOwnProperty||k;for(b in a)e&&"prototype"==b||!d.call(a,b)||c(b);for(e=m.length;b=m[--e];d.call(a,b)&&c(b));});return H(a,c)};if(!e("json-stringify")){var S={92:"\\\\",
34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},C=function(a,c){return("000000"+(c||0)).slice(-a)},O=function(a){for(var c='"',e=0,b=a.length,d=!F||10<b,m=d&&(F?a.split(""):a);e<b;e++){var f=a.charCodeAt(e);switch(f){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=S[f];break;default:c=32>f?c+("\\u00"+C(2,f.toString(16))):c+(d?m[e]:a.charAt(e))}}return c+'"'},M=function(a,c,e,b,d,m,f){var h;try{var g=c[a]}catch(Z){}if("object"==typeof g&&g){var t=q.call(g);if("[object Date]"!=t||k.call(g,
"toJSON"))"function"==typeof g.toJSON&&("[object Number]"!=t&&"[object String]"!=t&&"[object Array]"!=t||k.call(g,"toJSON"))&&(g=g.toJSON(a));else if(g>-1/0&&g<1/0){if(G){var l=B(g/864E5);for(t=B(l/365.2425)+1970-1;G(t+1,0)<=l;t++);for(h=B((l-G(t,0))/30.42);G(t,h+1)<=l;h++);l=1+l-G(t,h);var r=(g%864E5+864E5)%864E5;var n=B(r/36E5)%24;var I=B(r/6E4)%60;var y=B(r/1E3)%60;r%=1E3}else t=g.getUTCFullYear(),h=g.getUTCMonth(),l=g.getUTCDate(),n=g.getUTCHours(),I=g.getUTCMinutes(),y=g.getUTCSeconds(),r=g.getUTCMilliseconds();
g=(0>=t||1E4<=t?(0>t?"-":"+")+C(6,0>t?-t:t):C(4,t))+"-"+C(2,h+1)+"-"+C(2,l)+"T"+C(2,n)+":"+C(2,I)+":"+C(2,y)+"."+C(3,r)+"Z"}else g=null}e&&(g=e.call(c,a,g));if(null===g)return"null";t=q.call(g);if("[object Boolean]"==t)return""+g;if("[object Number]"==t)return g>-1/0&&g<1/0?""+g:"null";if("[object String]"==t)return O(""+g);if("object"==typeof g){for(a=f.length;a--;)if(f[a]===g)throw p();f.push(g);var D=[];c=m;m+=d;if("[object Array]"==t){h=0;for(a=g.length;h<a;h++)t=M(h,g,e,b,d,m,f),D.push(t===z?
"null":t);a=D.length?d?"[\n"+m+D.join(",\n"+m)+"\n"+c+"]":"["+D.join(",")+"]":"[]"}else H(b||g,function(a){var c=M(a,g,e,b,d,m,f);c!==z&&D.push(O(a)+":"+(d?" ":"")+c)}),a=D.length?d?"{\n"+m+D.join(",\n"+m)+"\n"+c+"}":"{"+D.join(",")+"}":"{}";f.pop();return a}};c.stringify=function(a,c,e){var b;if(l[typeof c]&&c)if("[object Function]"==(b=q.call(c)))var d=c;else if("[object Array]"==b){var m={};for(var f=0,h=c.length,g;f<h;g=c[f++],(b=q.call(g),"[object String]"==b||"[object Number]"==b)&&(m[g]=1));
}if(e)if("[object Number]"==(b=q.call(e))){if(0<(e-=e%1)){var t="";for(10<e&&(e=10);t.length<e;t+=" ");}}else"[object String]"==b&&(t=10>=e.length?e:e.slice(0,10));return M("",(g={},g[""]=a,g),d,m,t,"",[])}}if(!e("json-parse")){var T=m.fromCharCode,U={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},u,K,w=function(){u=K=null;throw t();},E=function(){for(var a=K,c=a.length,e,b,d,m,f;u<c;)switch(f=a.charCodeAt(u),f){case 9:case 10:case 13:case 32:u++;break;case 123:case 125:case 91:case 93:case 58:case 44:return e=
F?a.charAt(u):a[u],u++,e;case 34:e="@";for(u++;u<c;)if(f=a.charCodeAt(u),32>f)w();else if(92==f)switch(f=a.charCodeAt(++u),f){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:e+=U[f];u++;break;case 117:b=++u;for(d=u+4;u<d;u++)f=a.charCodeAt(u),48<=f&&57>=f||97<=f&&102>=f||65<=f&&70>=f||w();e+=T("0x"+a.slice(b,u));break;default:w()}else{if(34==f)break;f=a.charCodeAt(u);for(b=u;32<=f&&92!=f&&34!=f;)f=a.charCodeAt(++u);e+=a.slice(b,u)}if(34==a.charCodeAt(u))return u++,e;w();default:b=
u;45==f&&(m=!0,f=a.charCodeAt(++u));if(48<=f&&57>=f){for(48==f&&(f=a.charCodeAt(u+1),48<=f&&57>=f)&&w();u<c&&(f=a.charCodeAt(u),48<=f&&57>=f);u++);if(46==a.charCodeAt(u)){for(d=++u;d<c&&(f=a.charCodeAt(d),48<=f&&57>=f);d++);d==u&&w();u=d}f=a.charCodeAt(u);if(101==f||69==f){f=a.charCodeAt(++u);43!=f&&45!=f||u++;for(d=u;d<c&&(f=a.charCodeAt(d),48<=f&&57>=f);d++);d==u&&w();u=d}return+a.slice(b,u)}m&&w();if("true"==a.slice(u,u+4))return u+=4,!0;if("false"==a.slice(u,u+5))return u+=5,!1;if("null"==a.slice(u,
u+4))return u+=4,null;w()}return"$"},N=function(a){var c,e;"$"==a&&w();if("string"==typeof a){if("@"==(F?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(c=[];;e||(e=!0)){a=E();if("]"==a)break;e&&(","==a?(a=E(),"]"==a&&w()):w());","==a&&w();c.push(N(a))}return c}if("{"==a){for(c={};;e||(e=!0)){a=E();if("}"==a)break;e&&(","==a?(a=E(),"}"==a&&w()):w());","!=a&&"string"==typeof a&&"@"==(F?a.charAt(0):a[0])&&":"==E()||w();c[a.slice(1)]=N(E())}return c}w()}return a},Q=function(a,c,e){e=P(a,c,e);e===
z?delete a[c]:a[c]=e},P=function(a,c,e){var b=a[c],d;if("object"==typeof b&&b)if("[object Array]"==q.call(b))for(d=b.length;d--;)Q(b,d,e);else H(b,function(a){Q(b,a,e)});return e.call(a,c,b)};c.parse=function(a,c){var e;u=0;K=""+a;var b=N(E());"$"!=E()&&w();u=K=null;return c&&"[object Function]"==q.call(c)?P((e={},e[""]=b,e),"",c):b}}}c.runInContext=b;return c}var l={"function":!0,object:!0},g=l[typeof d]&&d&&!d.nodeType&&d,h=l[typeof window]&&window||this,r=g&&l[typeof c]&&c&&!c.nodeType&&"object"==
typeof a&&a;!r||r.global!==r&&r.window!==r&&r.self!==r||(h=r);if(g)b(h,g);else{var p=h.JSON,q=h.JSON3,n=!1,m=b(h,h.JSON3={noConflict:function(){n||(n=!0,h.JSON=p,h.JSON3=q,p=q=null);return m}});h.JSON={parse:m.parse,stringify:m.stringify}}}).call(this)}).call(d,b(12)(k),function(){return this}())},function(k,d){k.exports=function(b){b.webpackPolyfill||(b.deprecate=function(){},b.paths=[],b.children=[],b.webpackPolyfill=1);return b}},function(k,d){function b(c){if(c){for(var a in b.prototype)c[a]=
b.prototype[a];return c}}k.exports=b;b.prototype.on=b.prototype.addEventListener=function(c,a){this._callbacks=this._callbacks||{};(this._callbacks[c]=this._callbacks[c]||[]).push(a);return this};b.prototype.once=function(c,a){function b(){d.off(c,b);a.apply(this,arguments)}var d=this;this._callbacks=this._callbacks||{};b.fn=a;this.on(c,b);return this};b.prototype.off=b.prototype.removeListener=b.prototype.removeAllListeners=b.prototype.removeEventListener=function(c,a){this._callbacks=this._callbacks||
{};if(0==arguments.length)return this._callbacks={},this;var b=this._callbacks[c];if(!b)return this;if(1==arguments.length)return delete this._callbacks[c],this;for(var d,g=0;g<b.length;g++)if(d=b[g],d===a||d.fn===a){b.splice(g,1);break}return this};b.prototype.emit=function(c){this._callbacks=this._callbacks||{};var a=[].slice.call(arguments,1),b=this._callbacks[c];if(b){b=b.slice(0);for(var d=0,g=b.length;d<g;++d)b[d].apply(this,a)}return this};b.prototype.listeners=function(c){this._callbacks=
this._callbacks||{};return this._callbacks[c]||[]};b.prototype.hasListeners=function(c){return!!this.listeners(c).length}},function(k,d,b){(function(c){var a=b(15),f=b(16);d.deconstructPacket=function(c){function b(c){if(!c)return c;if(f(c)){var g={_placeholder:!0,num:d.length};d.push(c);return g}if(a(c)){g=Array(c.length);for(var h=0;h<c.length;h++)g[h]=b(c[h]);return g}if("object"==typeof c&&!(c instanceof Date)){g={};for(h in c)g[h]=b(c[h]);return g}return c}var d=[];c.data=b(c.data);c.attachments=
d.length;return{packet:c,buffers:d}};d.reconstructPacket=function(c,b){function d(c){if(c&&c._placeholder)return b[c.num];if(a(c))for(var f=0;f<c.length;f++)c[f]=d(c[f]);else if(c&&"object"==typeof c)for(f in c)c[f]=d(c[f]);return c}c.data=d(c.data);c.attachments=void 0;return c};d.removeBlobs=function(b,d){function g(b,h,m){if(!b)return b;if(c.Blob&&b instanceof Blob||c.File&&b instanceof File){l++;var e=new FileReader;e.onload=function(){m?m[h]=this.result:p=this.result;--l||d(p)};e.readAsArrayBuffer(b)}else if(a(b))for(e=
0;e<b.length;e++)g(b[e],e,b);else if(b&&"object"==typeof b&&!f(b))for(e in b)g(b[e],e,b)}var l=0,p=b;g(p);l||d(p)}}).call(d,function(){return this}())},function(k,d){k.exports=Array.isArray||function(b){return"[object Array]"==Object.prototype.toString.call(b)}},function(k,d){(function(b){k.exports=function(c){return b.Buffer&&b.Buffer.isBuffer(c)||b.ArrayBuffer&&c instanceof ArrayBuffer}}).call(d,function(){return this}())},function(k,d,b){function c(e,b){if(!(this instanceof c))return new c(e,b);
e&&"object"===("undefined"===typeof e?"undefined":a(e))&&(b=e,e=void 0);b=b||{};b.path=b.path||"/socket.io";this.nsps={};this.subs=[];this.opts=b;this.reconnection(!1!==b.reconnection);this.reconnectionAttempts(b.reconnectionAttempts||Infinity);this.reconnectionDelay(b.reconnectionDelay||1E3);this.reconnectionDelayMax(b.reconnectionDelayMax||5E3);this.randomizationFactor(b.randomizationFactor||.5);this.backoff=new n({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()});
this.timeout(null==b.timeout?2E4:b.timeout);this.readyState="closed";this.uri=e;this.connecting=[];this.lastPing=null;this.encoding=!1;this.packetBuffer=[];this.encoder=new g.Encoder;this.decoder=new g.Decoder;(this.autoConnect=!1!==b.autoConnect)&&this.open()}var a="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},f=b(18),l=b(44);d=b(35);var g=
b(7),h=b(46),r=b(47),p=b(3)("socket.io-client:manager"),q=b(42),n=b(48),m=Object.prototype.hasOwnProperty;k.exports=c;c.prototype.emitAll=function(){this.emit.apply(this,arguments);for(var a in this.nsps)m.call(this.nsps,a)&&this.nsps[a].emit.apply(this.nsps[a],arguments)};c.prototype.updateSocketIds=function(){for(var a in this.nsps)m.call(this.nsps,a)&&(this.nsps[a].id=this.engine.id)};d(c.prototype);c.prototype.reconnection=function(a){if(!arguments.length)return this._reconnection;this._reconnection=
!!a;return this};c.prototype.reconnectionAttempts=function(a){if(!arguments.length)return this._reconnectionAttempts;this._reconnectionAttempts=a;return this};c.prototype.reconnectionDelay=function(a){if(!arguments.length)return this._reconnectionDelay;this._reconnectionDelay=a;this.backoff&&this.backoff.setMin(a);return this};c.prototype.randomizationFactor=function(a){if(!arguments.length)return this._randomizationFactor;this._randomizationFactor=a;this.backoff&&this.backoff.setJitter(a);return this};
c.prototype.reconnectionDelayMax=function(a){if(!arguments.length)return this._reconnectionDelayMax;this._reconnectionDelayMax=a;this.backoff&&this.backoff.setMax(a);return this};c.prototype.timeout=function(a){if(!arguments.length)return this._timeout;this._timeout=a;return this};c.prototype.maybeReconnectOnOpen=function(){!this.reconnecting&&this._reconnection&&0===this.backoff.attempts&&this.reconnect()};c.prototype.open=c.prototype.connect=function(a,c){p("readyState %s",this.readyState);if(~this.readyState.indexOf("open"))return this;
p("opening %s",this.uri);var b=this.engine=f(this.uri,this.opts),e=this;this.readyState="opening";this.skipReconnect=!1;var d=h(b,"open",function(){e.onopen();a&&a()}),m=h(b,"error",function(c){p("connect_error");e.cleanup();e.readyState="closed";e.emitAll("connect_error",c);if(a){var b=Error("Connection error");b.data=c;a(b)}else e.maybeReconnectOnOpen()});if(!1!==this._timeout){var g=this._timeout;p("connect attempt will timeout after %d",g);var t=setTimeout(function(){p("connect attempt timed out after %d",
g);d.destroy();b.close();b.emit("error","timeout");e.emitAll("connect_timeout",g)},g);this.subs.push({destroy:function(){clearTimeout(t)}})}this.subs.push(d);this.subs.push(m);return this};c.prototype.onopen=function(){p("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(h(a,"data",r(this,"ondata")));this.subs.push(h(a,"ping",r(this,"onping")));this.subs.push(h(a,"pong",r(this,"onpong")));this.subs.push(h(a,"error",r(this,"onerror")));this.subs.push(h(a,
"close",r(this,"onclose")));this.subs.push(h(this.decoder,"decoded",r(this,"ondecoded")))};c.prototype.onping=function(){this.lastPing=new Date;this.emitAll("ping")};c.prototype.onpong=function(){this.emitAll("pong",new Date-this.lastPing)};c.prototype.ondata=function(a){this.decoder.add(a)};c.prototype.ondecoded=function(a){this.emit("packet",a)};c.prototype.onerror=function(a){p("error",a);this.emitAll("error",a)};c.prototype.socket=function(a,c){function b(){~q(d.connecting,e)||d.connecting.push(e)}
var e=this.nsps[a];if(!e){e=new l(this,a,c);this.nsps[a]=e;var d=this;e.on("connecting",b);e.on("connect",function(){e.id=d.engine.id});this.autoConnect&&b()}return e};c.prototype.destroy=function(a){a=q(this.connecting,a);~a&&this.connecting.splice(a,1);this.connecting.length||this.close()};c.prototype.packet=function(a){p("writing packet %j",a);var c=this;a.query&&0===a.type&&(a.nsp+="?"+a.query);c.encoding?c.packetBuffer.push(a):(c.encoding=!0,this.encoder.encode(a,function(b){for(var e=0;e<b.length;e++)c.engine.write(b[e],
a.options);c.encoding=!1;c.processPacketQueue()}))};c.prototype.processPacketQueue=function(){if(0<this.packetBuffer.length&&!this.encoding){var a=this.packetBuffer.shift();this.packet(a)}};c.prototype.cleanup=function(){p("cleanup");for(var a=this.subs.length,c=0;c<a;c++)this.subs.shift().destroy();this.packetBuffer=[];this.encoding=!1;this.lastPing=null;this.decoder.destroy()};c.prototype.close=c.prototype.disconnect=function(){p("disconnect");this.skipReconnect=!0;this.reconnecting=!1;"opening"===
this.readyState&&this.cleanup();this.backoff.reset();this.readyState="closed";this.engine&&this.engine.close()};c.prototype.onclose=function(a){p("onclose");this.cleanup();this.backoff.reset();this.readyState="closed";this.emit("close",a);this._reconnection&&!this.skipReconnect&&this.reconnect()};c.prototype.reconnect=function(){if(this.reconnecting||this.skipReconnect)return this;var a=this;if(this.backoff.attempts>=this._reconnectionAttempts)p("reconnect failed"),this.backoff.reset(),this.emitAll("reconnect_failed"),
this.reconnecting=!1;else{var c=this.backoff.duration();p("will wait %dms before reconnect attempt",c);this.reconnecting=!0;var b=setTimeout(function(){a.skipReconnect||(p("attempting reconnect"),a.emitAll("reconnect_attempt",a.backoff.attempts),a.emitAll("reconnecting",a.backoff.attempts),a.skipReconnect||a.open(function(c){c?(p("reconnect attempt error"),a.reconnecting=!1,a.reconnect(),a.emitAll("reconnect_error",c.data)):(p("reconnect success"),a.onreconnect())}))},c);this.subs.push({destroy:function(){clearTimeout(b)}})}};
c.prototype.onreconnect=function(){var a=this.backoff.attempts;this.reconnecting=!1;this.backoff.reset();this.updateSocketIds();this.emitAll("reconnect",a)}},function(k,d,b){k.exports=b(19)},function(k,d,b){k.exports=b(20);k.exports.parser=b(27)},function(k,d,b){(function(c){function a(b,e){if(!(this instanceof a))return new a(b,e);e=e||{};b&&"object"===typeof b&&(e=b,b=null);b?(b=p(b),e.hostname=b.host,e.secure="https"===b.protocol||"wss"===b.protocol,e.port=b.port,b.query&&(e.query=b.query)):e.host&&
(e.hostname=p(e.host).host);this.secure=null!=e.secure?e.secure:c.location&&"https:"===location.protocol;e.hostname&&!e.port&&(e.port=this.secure?"443":"80");this.agent=e.agent||!1;this.hostname=e.hostname||(c.location?location.hostname:"localhost");this.port=e.port||(c.location&&location.port?location.port:this.secure?443:80);this.query=e.query||{};"string"===typeof this.query&&(this.query=n.decode(this.query));this.upgrade=!1!==e.upgrade;this.path=(e.path||"/engine.io").replace(/\/$/,"")+"/";this.forceJSONP=
!!e.forceJSONP;this.jsonp=!1!==e.jsonp;this.forceBase64=!!e.forceBase64;this.enablesXDR=!!e.enablesXDR;this.timestampParam=e.timestampParam||"t";this.timestampRequests=e.timestampRequests;this.transports=e.transports||["polling","websocket"];this.readyState="";this.writeBuffer=[];this.prevBufferLen=0;this.policyPort=e.policyPort||843;this.rememberUpgrade=e.rememberUpgrade||!1;this.binaryType=null;this.onlyBinaryUpgrades=e.onlyBinaryUpgrades;this.perMessageDeflate=!1!==e.perMessageDeflate?e.perMessageDeflate||
{}:!1;!0===this.perMessageDeflate&&(this.perMessageDeflate={});this.perMessageDeflate&&null==this.perMessageDeflate.threshold&&(this.perMessageDeflate.threshold=1024);this.pfx=e.pfx||null;this.key=e.key||null;this.passphrase=e.passphrase||null;this.cert=e.cert||null;this.ca=e.ca||null;this.ciphers=e.ciphers||null;this.rejectUnauthorized=void 0===e.rejectUnauthorized?null:e.rejectUnauthorized;this.forceNode=!!e.forceNode;var d="object"===typeof c&&c;d.global===d&&(e.extraHeaders&&0<Object.keys(e.extraHeaders).length&&
(this.extraHeaders=e.extraHeaders),e.localAddress&&(this.localAddress=e.localAddress));this.pingTimeoutTimer=this.pingIntervalTimer=this.pingTimeout=this.pingInterval=this.upgrades=this.id=null;this.open()}var d=b(21),l=b(35),g=b(3)("engine.io-client:socket"),h=b(42),r=b(27),p=b(2),q=b(43),n=b(36);k.exports=a;a.priorWebsocketSuccess=!1;l(a.prototype);a.protocol=r.protocol;a.Socket=a;a.Transport=b(26);a.transports=b(21);a.parser=b(27);a.prototype.createTransport=function(a){g('creating transport "%s"',
a);var c=this.query,b={},f;for(f in c)c.hasOwnProperty(f)&&(b[f]=c[f]);b.EIO=r.protocol;b.transport=a;this.id&&(b.sid=this.id);return new d[a]({agent:this.agent,hostname:this.hostname,port:this.port,secure:this.secure,path:this.path,query:b,forceJSONP:this.forceJSONP,jsonp:this.jsonp,forceBase64:this.forceBase64,enablesXDR:this.enablesXDR,timestampRequests:this.timestampRequests,timestampParam:this.timestampParam,policyPort:this.policyPort,socket:this,pfx:this.pfx,key:this.key,passphrase:this.passphrase,
cert:this.cert,ca:this.ca,ciphers:this.ciphers,rejectUnauthorized:this.rejectUnauthorized,perMessageDeflate:this.perMessageDeflate,extraHeaders:this.extraHeaders,forceNode:this.forceNode,localAddress:this.localAddress})};a.prototype.open=function(){if(this.rememberUpgrade&&a.priorWebsocketSuccess&&-1!==this.transports.indexOf("websocket"))var c="websocket";else{if(0===this.transports.length){var b=this;setTimeout(function(){b.emit("error","No transports available")},0);return}c=this.transports[0]}this.readyState=
"opening";try{c=this.createTransport(c)}catch(t){this.transports.shift();this.open();return}c.open();this.setTransport(c)};a.prototype.setTransport=function(a){g("setting transport %s",a.name);var c=this;this.transport&&(g("clearing existing transport %s",this.transport.name),this.transport.removeAllListeners());this.transport=a;a.on("drain",function(){c.onDrain()}).on("packet",function(a){c.onPacket(a)}).on("error",function(a){c.onError(a)}).on("close",function(){c.onClose("transport close")})};
a.prototype.probe=function(c){function b(){if(q.onlyBinaryUpgrades){var b=!this.supportsBinary&&q.transport.supportsBinary;k=k||b}k||(g('probe transport "%s" opened',c),n.send([{type:"ping",data:"probe"}]),n.once("packet",function(b){k||("pong"===b.type&&"probe"===b.data?(g('probe transport "%s" pong',c),q.upgrading=!0,q.emit("upgrading",n),n&&(a.priorWebsocketSuccess="websocket"===n.name,g('pausing current transport "%s"',q.transport.name),q.transport.pause(function(){k||"closed"===q.readyState||
(g("changing transport and sending upgrade packet"),p(),q.setTransport(n),n.send([{type:"upgrade"}]),q.emit("upgrade",n),n=null,q.upgrading=!1,q.flush())}))):(g('probe transport "%s" failed',c),b=Error("probe error"),b.transport=n.name,q.emit("upgradeError",b)))}))}function d(){k||(k=!0,p(),n.close(),n=null)}function f(a){var b=Error("probe error: "+a);b.transport=n.name;d();g('probe transport "%s" failed because of error: %s',c,a);q.emit("upgradeError",b)}function m(){f("transport closed")}function h(){f("socket closed")}
function l(a){n&&a.name!==n.name&&(g('"%s" works - aborting "%s"',a.name,n.name),d())}function p(){n.removeListener("open",b);n.removeListener("error",f);n.removeListener("close",m);q.removeListener("close",h);q.removeListener("upgrading",l)}g('probing transport "%s"',c);var n=this.createTransport(c,{probe:1}),k=!1,q=this;a.priorWebsocketSuccess=!1;n.once("open",b);n.once("error",f);n.once("close",m);this.once("close",h);this.once("upgrading",l);n.open()};a.prototype.onOpen=function(){g("socket open");
this.readyState="open";a.priorWebsocketSuccess="websocket"===this.transport.name;this.emit("open");this.flush();if("open"===this.readyState&&this.upgrade&&this.transport.pause){g("starting upgrade probes");for(var c=0,b=this.upgrades.length;c<b;c++)this.probe(this.upgrades[c])}};a.prototype.onPacket=function(a){if("opening"===this.readyState||"open"===this.readyState||"closing"===this.readyState)switch(g('socket receive: type "%s", data "%s"',a.type,a.data),this.emit("packet",a),this.emit("heartbeat"),
a.type){case "open":this.onHandshake(q(a.data));break;case "pong":this.setPing();this.emit("pong");break;case "error":var c=Error("server error");c.code=a.data;this.onError(c);break;case "message":this.emit("data",a.data),this.emit("message",a.data)}else g('packet received with socket readyState "%s"',this.readyState)};a.prototype.onHandshake=function(a){this.emit("handshake",a);this.id=a.sid;this.transport.query.sid=a.sid;this.upgrades=this.filterUpgrades(a.upgrades);this.pingInterval=a.pingInterval;
this.pingTimeout=a.pingTimeout;this.onOpen();"closed"!==this.readyState&&(this.setPing(),this.removeListener("heartbeat",this.onHeartbeat),this.on("heartbeat",this.onHeartbeat))};a.prototype.onHeartbeat=function(a){clearTimeout(this.pingTimeoutTimer);var c=this;c.pingTimeoutTimer=setTimeout(function(){if("closed"!==c.readyState)c.onClose("ping timeout")},a||c.pingInterval+c.pingTimeout)};a.prototype.setPing=function(){var a=this;clearTimeout(a.pingIntervalTimer);a.pingIntervalTimer=setTimeout(function(){g("writing ping packet - expecting pong within %sms",
a.pingTimeout);a.ping();a.onHeartbeat(a.pingTimeout)},a.pingInterval)};a.prototype.ping=function(){var a=this;this.sendPacket("ping",function(){a.emit("ping")})};a.prototype.onDrain=function(){this.writeBuffer.splice(0,this.prevBufferLen);this.prevBufferLen=0;0===this.writeBuffer.length?this.emit("drain"):this.flush()};a.prototype.flush=function(){"closed"!==this.readyState&&this.transport.writable&&!this.upgrading&&this.writeBuffer.length&&(g("flushing %d packets in socket",this.writeBuffer.length),
this.transport.send(this.writeBuffer),this.prevBufferLen=this.writeBuffer.length,this.emit("flush"))};a.prototype.write=a.prototype.send=function(a,c,b){this.sendPacket("message",a,c,b);return this};a.prototype.sendPacket=function(a,c,b,d){"function"===typeof c&&(d=c,c=void 0);"function"===typeof b&&(d=b,b=null);if("closing"!==this.readyState&&"closed"!==this.readyState){b=b||{};b.compress=!1!==b.compress;a={type:a,data:c,options:b};this.emit("packetCreate",a);this.writeBuffer.push(a);if(d)this.once("flush",
d);this.flush()}};a.prototype.close=function(){function a(){d.onClose("forced close");g("socket closing - telling transport to close");d.transport.close()}function c(){d.removeListener("upgrade",c);d.removeListener("upgradeError",c);a()}function b(){d.once("upgrade",c);d.once("upgradeError",c)}if("opening"===this.readyState||"open"===this.readyState){this.readyState="closing";var d=this;if(this.writeBuffer.length)this.once("drain",function(){this.upgrading?b():a()});else this.upgrading?b():a()}return this};
a.prototype.onError=function(c){g("socket error %j",c);a.priorWebsocketSuccess=!1;this.emit("error",c);this.onClose("transport error",c)};a.prototype.onClose=function(a,c){if("opening"===this.readyState||"open"===this.readyState||"closing"===this.readyState)g('socket close with reason: "%s"',a),clearTimeout(this.pingIntervalTimer),clearTimeout(this.pingTimeoutTimer),this.transport.removeAllListeners("close"),this.transport.close(),this.transport.removeAllListeners(),this.readyState="closed",this.id=
null,this.emit("close",a,c),this.writeBuffer=[],this.prevBufferLen=0};a.prototype.filterUpgrades=function(a){for(var c=[],b=0,d=a.length;b<d;b++)~h(this.transports,a[b])&&c.push(a[b]);return c}}).call(d,function(){return this}())},function(k,d,b){(function(c){var a=b(22),f=b(24),l=b(39),g=b(40);d.polling=function(b){var d=!1,g=!1,h=!1!==b.jsonp;c.location&&(g="https:"===location.protocol,(d=location.port)||(d=g?443:80),d=b.hostname!==location.hostname||d!==b.port,g=b.secure!==g);b.xdomain=d;b.xscheme=
g;if("open"in new a(b)&&!b.forceJSONP)return new f(b);if(!h)throw Error("JSONP disabled");return new l(b)};d.websocket=g}).call(d,function(){return this}())},function(k,d,b){(function(c){var a=b(23);k.exports=function(b){var d=b.xdomain,f=b.xscheme;b=b.enablesXDR;try{if("undefined"!==typeof XMLHttpRequest&&(!d||a))return new XMLHttpRequest}catch(h){}try{if("undefined"!==typeof XDomainRequest&&!f&&b)return new XDomainRequest}catch(h){}if(!d)try{return new (c[["Active"].concat("Object").join("X")])("Microsoft.XMLHTTP")}catch(h){}}}).call(d,
function(){return this}())},function(k,d){try{k.exports="undefined"!==typeof XMLHttpRequest&&"withCredentials"in new XMLHttpRequest}catch(b){k.exports=!1}},function(k,d,b){(function(c){function a(){}function d(a){r.call(this,a);this.requestTimeout=a.requestTimeout;if(c.location){var b="https:"===location.protocol,d=location.port;d||(d=b?443:80);this.xd=a.hostname!==c.location.hostname||d!==a.port;this.xs=a.secure!==b}else this.extraHeaders=a.extraHeaders}function l(a){this.method=a.method||"GET";
this.uri=a.uri;this.xd=!!a.xd;this.xs=!!a.xs;this.async=!1!==a.async;this.data=void 0!==a.data?a.data:null;this.agent=a.agent;this.isBinary=a.isBinary;this.supportsBinary=a.supportsBinary;this.enablesXDR=a.enablesXDR;this.requestTimeout=a.requestTimeout;this.pfx=a.pfx;this.key=a.key;this.passphrase=a.passphrase;this.cert=a.cert;this.ca=a.ca;this.ciphers=a.ciphers;this.rejectUnauthorized=a.rejectUnauthorized;this.extraHeaders=a.extraHeaders;this.create()}function g(){for(var a in l.requests)l.requests.hasOwnProperty(a)&&
l.requests[a].abort()}var h=b(22),r=b(25),p=b(35),q=b(37),n=b(3)("engine.io-client:polling-xhr");k.exports=d;k.exports.Request=l;q(d,r);d.prototype.supportsBinary=!0;d.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;a.pfx=this.pfx;a.key=this.key;a.passphrase=this.passphrase;a.cert=this.cert;a.ca=this.ca;a.ciphers=this.ciphers;a.rejectUnauthorized=this.rejectUnauthorized;a.requestTimeout=
this.requestTimeout;a.extraHeaders=this.extraHeaders;return new l(a)};d.prototype.doWrite=function(a,c){var b=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),d=this;b.on("success",c);b.on("error",function(a){d.onError("xhr post error",a)});this.sendXhr=b};d.prototype.doPoll=function(){n("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};p(l.prototype);l.prototype.create=
function(){var a={agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR};a.pfx=this.pfx;a.key=this.key;a.passphrase=this.passphrase;a.cert=this.cert;a.ca=this.ca;a.ciphers=this.ciphers;a.rejectUnauthorized=this.rejectUnauthorized;var b=this.xhr=new h(a),d=this;try{n("xhr open %s: %s",this.method,this.uri);b.open(this.method,this.uri,this.async);try{if(this.extraHeaders){b.setDisableHeaderCheck(!0);for(var f in this.extraHeaders)this.extraHeaders.hasOwnProperty(f)&&b.setRequestHeader(f,
this.extraHeaders[f])}}catch(v){}this.supportsBinary&&(b.responseType="arraybuffer");if("POST"===this.method)try{this.isBinary?b.setRequestHeader("Content-type","application/octet-stream"):b.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch(v){}try{b.setRequestHeader("Accept","*/*")}catch(v){}"withCredentials"in b&&(b.withCredentials=!0);this.requestTimeout&&(b.timeout=this.requestTimeout);this.hasXDR()?(b.onload=function(){d.onLoad()},b.onerror=function(){d.onError(b.responseText)}):
b.onreadystatechange=function(){if(4===b.readyState)if(200===b.status||1223===b.status)d.onLoad();else setTimeout(function(){d.onError(b.status)},0)};n("xhr data %s",this.data);b.send(this.data)}catch(v){setTimeout(function(){d.onError(v)},0);return}c.document&&(this.index=l.requestsCount++,l.requests[this.index]=this)};l.prototype.onSuccess=function(){this.emit("success");this.cleanup()};l.prototype.onData=function(a){this.emit("data",a);this.onSuccess()};l.prototype.onError=function(a){this.emit("error",
a);this.cleanup(!0)};l.prototype.cleanup=function(b){if("undefined"!==typeof this.xhr&&null!==this.xhr){this.hasXDR()?this.xhr.onload=this.xhr.onerror=a:this.xhr.onreadystatechange=a;if(b)try{this.xhr.abort()}catch(e){}c.document&&delete l.requests[this.index];this.xhr=null}};l.prototype.onLoad=function(){try{try{var a=this.xhr.getResponseHeader("Content-Type").split(";")[0]}catch(x){}if("application/octet-stream"===a)var c=this.xhr.response||this.xhr.responseText;else if(this.supportsBinary)try{c=
String.fromCharCode.apply(null,new Uint8Array(this.xhr.response))}catch(x){var b=new Uint8Array(this.xhr.response);a=[];for(var d=0,f=b.length;d<f;d++)a.push(b[d]);c=String.fromCharCode.apply(null,a)}else c=this.xhr.responseText}catch(x){this.onError(x)}if(null!=c)this.onData(c)};l.prototype.hasXDR=function(){return"undefined"!==typeof c.XDomainRequest&&!this.xs&&this.enablesXDR};l.prototype.abort=function(){this.cleanup()};l.requestsCount=0;l.requests={};c.document&&(c.attachEvent?c.attachEvent("onunload",
g):c.addEventListener&&c.addEventListener("beforeunload",g,!1))}).call(d,function(){return this}())},function(k,d,b){function c(c){var b=c&&c.forceBase64;if(!r||b)this.supportsBinary=!1;a.call(this,c)}var a=b(26),f=b(36),l=b(27);d=b(37);var g=b(38),h=b(3)("engine.io-client:polling");k.exports=c;var r=null!=(new (b(22))({xdomain:!1})).responseType;d(c,a);c.prototype.name="polling";c.prototype.doOpen=function(){this.poll()};c.prototype.pause=function(a){function c(){h("paused");b.readyState="paused";
a()}var b=this;this.readyState="pausing";if(this.polling||!this.writable){var d=0;this.polling&&(h("we are currently polling - waiting to pause"),d++,this.once("pollComplete",function(){h("pre-pause polling complete");--d||c()}));this.writable||(h("we are currently writing - waiting to pause"),d++,this.once("drain",function(){h("pre-pause writing complete");--d||c()}))}else c()};c.prototype.poll=function(){h("polling");this.polling=!0;this.doPoll();this.emit("poll")};c.prototype.onData=function(a){var c=
this;h("polling got data %s",a);l.decodePayload(a,this.socket.binaryType,function(a,b,d){if("opening"===c.readyState)c.onOpen();if("close"===a.type)return c.onClose(),!1;c.onPacket(a)});"closed"!==this.readyState&&(this.polling=!1,this.emit("pollComplete"),"open"===this.readyState?this.poll():h('ignoring poll - transport state "%s"',this.readyState))};c.prototype.doClose=function(){function a(){h("writing close packet");c.write([{type:"close"}])}var c=this;"open"===this.readyState?(h("transport open - closing"),
a()):(h("transport not open - deferring close"),this.once("open",a))};c.prototype.write=function(a){var c=this;this.writable=!1;var b=function(){c.writable=!0;c.emit("drain")};l.encodePayload(a,this.supportsBinary,function(a){c.doWrite(a,b)})};c.prototype.uri=function(){var a=this.query||{},c=this.secure?"https":"http",b="";!1!==this.timestampRequests&&(a[this.timestampParam]=g());this.supportsBinary||a.sid||(a.b64=1);a=f.encode(a);this.port&&("https"===c&&443!==Number(this.port)||"http"===c&&80!==
Number(this.port))&&(b=":"+this.port);a.length&&(a="?"+a);var d=-1!==this.hostname.indexOf(":");return c+"://"+(d?"["+this.hostname+"]":this.hostname)+b+this.path+a}},function(k,d,b){function c(a){this.path=a.path;this.hostname=a.hostname;this.port=a.port;this.secure=a.secure;this.query=a.query;this.timestampParam=a.timestampParam;this.timestampRequests=a.timestampRequests;this.readyState="";this.agent=a.agent||!1;this.socket=a.socket;this.enablesXDR=a.enablesXDR;this.pfx=a.pfx;this.key=a.key;this.passphrase=
a.passphrase;this.cert=a.cert;this.ca=a.ca;this.ciphers=a.ciphers;this.rejectUnauthorized=a.rejectUnauthorized;this.forceNode=a.forceNode;this.extraHeaders=a.extraHeaders;this.localAddress=a.localAddress}var a=b(27);d=b(35);k.exports=c;d(c.prototype);c.prototype.onError=function(a,c){var b=Error(a);b.type="TransportError";b.description=c;this.emit("error",b);return this};c.prototype.open=function(){if("closed"===this.readyState||""===this.readyState)this.readyState="opening",this.doOpen();return this};
c.prototype.close=function(){if("opening"===this.readyState||"open"===this.readyState)this.doClose(),this.onClose();return this};c.prototype.send=function(a){if("open"===this.readyState)this.write(a);else throw Error("Transport not open");};c.prototype.onOpen=function(){this.readyState="open";this.writable=!0;this.emit("open")};c.prototype.onData=function(c){c=a.decodePacket(c,this.socket.binaryType);this.onPacket(c)};c.prototype.onPacket=function(a){this.emit("packet",a)};c.prototype.onClose=function(){this.readyState=
"closed";this.emit("close")}},function(k,d,b){(function(c){function a(a,c,b){if(!c)return d.encodeBase64Packet(a,b);var e=new FileReader;e.onload=function(){a.data=e.result;d.encodePacket(a,c,!0,b)};return e.readAsArrayBuffer(a.data)}function f(a,c,b){var d=Array(a.length);b=k(a.length,b);for(var e=function(a,b,e){c(b,function(c,b){d[a]=b;e(c,d)})},f=0;f<a.length;f++)e(f,a[f],b)}var l=b(28),g=b(29),h=b(30),k=b(31),p=b(32),q;c&&c.ArrayBuffer&&(q=b(33));var n="undefined"!==typeof navigator&&/Android/i.test(navigator.userAgent),
m="undefined"!==typeof navigator&&/PhantomJS/i.test(navigator.userAgent),e=n||m;d.protocol=3;var t=d.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},y=l(t),v={type:"error",data:"parser error"},x=b(34);d.encodePacket=function(b,f,g,h){"function"==typeof f&&(h=f,f=!1);"function"==typeof g&&(h=g,g=null);var l=void 0===b.data?void 0:b.data.buffer||b.data;if(c.ArrayBuffer&&l instanceof ArrayBuffer){if(f){g=b.data;f=new Uint8Array(g);g=new Uint8Array(1+g.byteLength);g[0]=t[b.type];for(b=
0;b<f.length;b++)g[b+1]=f[b];b=h(g.buffer)}else b=d.encodeBase64Packet(b,h);return b}if(x&&l instanceof c.Blob)return f?e?b=a(b,f,h):(f=new Uint8Array(1),f[0]=t[b.type],b=new x([f.buffer,b.data]),b=h(b)):b=d.encodeBase64Packet(b,h),b;if(l&&l.base64)return h("b"+d.packets[b.type]+b.data.data);f=t[b.type];void 0!==b.data&&(f+=g?p.encode(String(b.data)):String(b.data));return h(""+f)};d.encodeBase64Packet=function(a,b){var e="b"+d.packets[a.type];if(x&&a.data instanceof c.Blob){var f=new FileReader;
f.onload=function(){var a=f.result.split(",")[1];b(e+a)};return f.readAsDataURL(a.data)}try{var g=String.fromCharCode.apply(null,new Uint8Array(a.data))}catch(Y){g=new Uint8Array(a.data);for(var h=Array(g.length),l=0;l<g.length;l++)h[l]=g[l];g=String.fromCharCode.apply(null,h)}e+=c.btoa(g);return b(e)};d.decodePacket=function(a,c,b){if(void 0===a)return v;if("string"==typeof a){if("b"==a.charAt(0))return d.decodeBase64Packet(a.substr(1),c);if(b){a:{c=a;try{c=p.decode(c)}catch(W){a=!1;break a}a=c}if(!1===
a)return v}b=a.charAt(0);return Number(b)==b&&y[b]?1<a.length?{type:y[b],data:a.substring(1)}:{type:y[b]}:v}b=(new Uint8Array(a))[0];a=h(a,1);x&&"blob"===c&&(a=new x([a]));return{type:y[b],data:a}};d.decodeBase64Packet=function(a,c){var b=y[a.charAt(0)];if(!q)return{type:b,data:{base64:!0,data:a.substr(1)}};var d=q.decode(a.substr(1));"blob"===c&&x&&(d=new x([d]));return{type:b,data:d}};d.encodePayload=function(a,c,b){"function"==typeof c&&(b=c,c=null);var h=g(a);if(c&&h)return x&&!e?d.encodePayloadAsBlob(a,
b):d.encodePayloadAsArrayBuffer(a,b);if(!a.length)return b("0:");f(a,function(a,b){d.encodePacket(a,h?c:!1,!0,function(a){b(null,a.length+":"+a)})},function(a,c){return b(c.join(""))})};d.decodePayload=function(a,c,b){if("string"!=typeof a)return d.decodePayloadAsBinary(a,c,b);"function"===typeof c&&(b=c,c=null);if(""==a)return b(v,0,1);var e="";for(var f,g,h=0,l=a.length;h<l;h++)if(g=a.charAt(h),":"!=g)e+=g;else{if(""==e||e!=(f=Number(e)))return b(v,0,1);g=a.substr(h+1,f);if(e!=g.length)return b(v,
0,1);if(g.length){e=d.decodePacket(g,c,!0);if(v.type==e.type&&v.data==e.data)return b(v,0,1);if(!1===b(e,h+f,l))return}h+=f;e=""}if(""!=e)return b(v,0,1)};d.encodePayloadAsArrayBuffer=function(a,c){if(!a.length)return c(new ArrayBuffer(0));f(a,function(a,c){d.encodePacket(a,!0,!0,function(a){return c(null,a)})},function(a,b){var d=b.reduce(function(a,c){var b="string"===typeof c?c.length:c.byteLength;return a+b.toString().length+b+2},0),e=new Uint8Array(d),f=0;b.forEach(function(a){var c="string"===
typeof a,b=a;if(c){b=new Uint8Array(a.length);for(var d=0;d<a.length;d++)b[d]=a.charCodeAt(d);b=b.buffer}c?e[f++]=0:e[f++]=1;a=b.byteLength.toString();for(d=0;d<a.length;d++)e[f++]=parseInt(a[d]);e[f++]=255;b=new Uint8Array(b);for(d=0;d<b.length;d++)e[f++]=b[d]});return c(e.buffer)})};d.encodePayloadAsBlob=function(a,c){f(a,function(a,c){d.encodePacket(a,!0,!0,function(a){var b=new Uint8Array(1);b[0]=1;if("string"===typeof a){for(var d=new Uint8Array(a.length),e=0;e<a.length;e++)d[e]=a.charCodeAt(e);
a=d.buffer;b[0]=0}d=(a instanceof ArrayBuffer?a.byteLength:a.size).toString();var f=new Uint8Array(d.length+1);for(e=0;e<d.length;e++)f[e]=parseInt(d[e]);f[d.length]=255;x&&(a=new x([b.buffer,f.buffer,a]),c(null,a))})},function(a,b){return c(new x(b))})};d.decodePayloadAsBinary=function(a,c,b){"function"===typeof c&&(b=c,c=null);for(var e=[],f=!1;0<a.byteLength;){for(var g=new Uint8Array(a),l=0===g[0],n="",k=1;255!=g[k];k++){if(310<n.length){f=!0;break}n+=g[k]}if(f)return b(v,0,1);a=h(a,2+n.length);
n=parseInt(n);g=h(a,0,n);if(l)try{g=String.fromCharCode.apply(null,new Uint8Array(g))}catch(F){for(l=new Uint8Array(g),g="",k=0;k<l.length;k++)g+=String.fromCharCode(l[k])}e.push(g);a=h(a,n)}var m=e.length;e.forEach(function(a,e){b(d.decodePacket(a,c,!0),e,m)})}}).call(d,function(){return this}())},function(k,d){k.exports=Object.keys||function(b){var c=[],a=Object.prototype.hasOwnProperty,d;for(d in b)a.call(b,d)&&c.push(d);return c}},function(k,d,b){(function(c){var a=b(15);k.exports=function(b){function d(b){if(!b)return!1;
if(c.Buffer&&c.Buffer.isBuffer&&c.Buffer.isBuffer(b)||c.ArrayBuffer&&b instanceof ArrayBuffer||c.Blob&&b instanceof Blob||c.File&&b instanceof File)return!0;if(a(b))for(var f=0;f<b.length;f++){if(d(b[f]))return!0}else if(b&&"object"==typeof b)for(f in b.toJSON&&"function"==typeof b.toJSON&&(b=b.toJSON()),b)if(Object.prototype.hasOwnProperty.call(b,f)&&d(b[f]))return!0;return!1}return d(b)}}).call(d,function(){return this}())},function(k,d){k.exports=function(b,c,a){var d=b.byteLength;c=c||0;a=a||
d;if(b.slice)return b.slice(c,a);0>c&&(c+=d);0>a&&(a+=d);a>d&&(a=d);if(c>=d||c>=a||0===d)return new ArrayBuffer(0);b=new Uint8Array(b);d=new Uint8Array(a-c);for(var l=0;c<a;c++,l++)d[l]=b[c];return d.buffer}},function(k,d){function b(){}k.exports=function(c,a,d){function f(b,c){if(0>=f.count)throw Error("after called too many times");--f.count;b?(g=!0,a(b),a=d):0!==f.count||g||a(null,c)}var g=!1;d=d||b;f.count=c;return 0===c?a():f}},function(k,d,b){var c;(function(a,b){(function(b){function d(a){for(var b=
[],c=0,d=a.length,e,f;c<d;)e=a.charCodeAt(c++),55296<=e&&56319>=e&&c<d?(f=a.charCodeAt(c++),56320==(f&64512)?b.push(((e&1023)<<10)+(f&1023)+65536):(b.push(e),c--)):b.push(e);return b}function f(){if(m>=n)throw Error("Invalid byte index");var a=q[m]&255;m++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function l(){if(m>n)throw Error("Invalid byte index");if(m==n)return!1;var a=q[m]&255;m++;if(0==(a&128))return a;if(192==(a&224)){var b=f();a=(a&31)<<6|b;if(128<=a)return a;throw Error("Invalid continuation byte");
}if(224==(a&240)){b=f();var c=f();a=(a&15)<<12|b<<6|c;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)){b=f();c=f();var d=f();a=(a&15)<<18|b<<12|c<<6|d;if(65536<=a&&1114111>=a)return a}throw Error("Invalid WTF-8 detected");}var k=String.fromCharCode,q,n,m;!(c={version:"1.0.0",encode:function(a){a=d(a);for(var b=a.length,c=-1,e,f="";++c<b;){e=a[c];if(0==(e&4294967168))e=k(e);else{var g="";0==(e&4294965248)?g=k(e>>6&31|192):0==(e&4294901760)?(g=k(e>>12&15|224),g+=k(e>>6&
63|128)):0==(e&4292870144)&&(g=k(e>>18&7|240),g+=k(e>>12&63|128),g+=k(e>>6&63|128));e=g+=k(e&63|128)}f+=e}return f},decode:function(a){q=d(a);n=q.length;m=0;a=[];for(var b;!1!==(b=l());)a.push(b);b=a.length;for(var c=-1,e,f="";++c<b;)e=a[c],65535<e&&(e-=65536,f+=k(e>>>10&1023|55296),e=56320|e&1023),f+=k(e);return f}},void 0!==c&&(a.exports=c))})(this)}).call(d,b(12)(k),function(){return this}())},function(k,d){(function(){for(var b=new Uint8Array(256),c=0;64>c;c++)b["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(c)]=
c;d.encode=function(a){a=new Uint8Array(a);var b,c=a.length,d="";for(b=0;b<c;b+=3)d+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[a[b]>>2],d+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[(a[b]&3)<<4|a[b+1]>>4],d+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[(a[b+1]&15)<<2|a[b+2]>>6],d+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[a[b+2]&63];2===c%3?d=d.substring(0,d.length-1)+"=":1===c%3&&(d=d.substring(0,d.length-
2)+"==");return d};d.decode=function(a){var c=.75*a.length,d=a.length,g=0;"="===a[a.length-1]&&(c--,"="===a[a.length-2]&&c--);var h=new ArrayBuffer(c),k=new Uint8Array(h);for(c=0;c<d;c+=4){var p=b[a.charCodeAt(c)];var q=b[a.charCodeAt(c+1)];var n=b[a.charCodeAt(c+2)];var m=b[a.charCodeAt(c+3)];k[g++]=p<<2|q>>4;k[g++]=(q&15)<<4|n>>2;k[g++]=(n&3)<<6|m&63}return h}})()},function(k,d){(function(b){function c(a){for(var b=0;b<a.length;b++){var c=a[b];if(c.buffer instanceof ArrayBuffer){var d=c.buffer;
if(c.byteLength!==d.byteLength){var e=new Uint8Array(c.byteLength);e.set(new Uint8Array(d,c.byteOffset,c.byteLength));d=e.buffer}a[b]=d}}}function a(a,b){b=b||{};var d=new l;c(a);for(var f=0;f<a.length;f++)d.append(a[f]);return b.type?d.getBlob(b.type):d.getBlob()}function d(a,b){c(a);return new Blob(a,b||{})}var l=b.BlobBuilder||b.WebKitBlobBuilder||b.MSBlobBuilder||b.MozBlobBuilder;try{var g=2===(new Blob(["hi"])).size}catch(p){g=!1}var h;if(h=g)try{h=2===(new Blob([new Uint8Array([1,2])])).size}catch(p){h=
!1}var r=l&&l.prototype.append&&l.prototype.getBlob;b=g?h?b.Blob:d:r?a:void 0;k.exports=b}).call(d,function(){return this}())},function(k,d,b){function c(a){if(a){for(var b in c.prototype)a[b]=c.prototype[b];return a}}k.exports=c;c.prototype.on=c.prototype.addEventListener=function(a,b){this._callbacks=this._callbacks||{};(this._callbacks["$"+a]=this._callbacks["$"+a]||[]).push(b);return this};c.prototype.once=function(a,b){function c(){this.off(a,c);b.apply(this,arguments)}c.fn=b;this.on(a,c);return this};
c.prototype.off=c.prototype.removeListener=c.prototype.removeAllListeners=c.prototype.removeEventListener=function(a,b){this._callbacks=this._callbacks||{};if(0==arguments.length)return this._callbacks={},this;var c=this._callbacks["$"+a];if(!c)return this;if(1==arguments.length)return delete this._callbacks["$"+a],this;for(var d,f=0;f<c.length;f++)if(d=c[f],d===b||d.fn===b){c.splice(f,1);break}return this};c.prototype.emit=function(a){this._callbacks=this._callbacks||{};var b=[].slice.call(arguments,
1),c=this._callbacks["$"+a];if(c){c=c.slice(0);for(var d=0,h=c.length;d<h;++d)c[d].apply(this,b)}return this};c.prototype.listeners=function(a){this._callbacks=this._callbacks||{};return this._callbacks["$"+a]||[]};c.prototype.hasListeners=function(a){return!!this.listeners(a).length}},function(k,d){d.encode=function(b){var c="",a;for(a in b)b.hasOwnProperty(a)&&(c.length&&(c+="&"),c+=encodeURIComponent(a)+"="+encodeURIComponent(b[a]));return c};d.decode=function(b){var c={};b=b.split("&");for(var a=
0,d=b.length;a<d;a++){var k=b[a].split("=");c[decodeURIComponent(k[0])]=decodeURIComponent(k[1])}return c}},function(k,d){k.exports=function(b,c){var a=function(){};a.prototype=c.prototype;b.prototype=new a;b.prototype.constructor=b}},function(k,d){function b(b){var c="";do c=a[b%64]+c,b=Math.floor(b/64);while(0<b);return c}function c(){var a=b(+new Date);return a!==h?(l=0,h=a):a+"."+b(l++)}for(var a="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""),f={},l=0,g=0,h;64>g;g++)f[a[g]]=
g;c.encode=b;c.decode=function(a){var b=0;for(g=0;g<a.length;g++)b=64*b+f[a.charAt(g)];return b};k.exports=c},function(k,d,b){(function(c){function a(){}function d(b){l.call(this,b);this.query=this.query||{};p||(c.___eio||(c.___eio=[]),p=c.___eio);this.index=p.length;var d=this;p.push(function(a){d.onData(a)});this.query.j=this.index;c.document&&c.addEventListener&&c.addEventListener("beforeunload",function(){d.script&&(d.script.onerror=a)},!1)}var l=b(25),g=b(37);k.exports=d;var h=/\n/g,r=/\\n/g,
p;g(d,l);d.prototype.supportsBinary=!1;d.prototype.doClose=function(){this.script&&(this.script.parentNode.removeChild(this.script),this.script=null);this.form&&(this.form.parentNode.removeChild(this.form),this.iframe=this.form=null);l.prototype.doClose.call(this)};d.prototype.doPoll=function(){var a=this,b=document.createElement("script");this.script&&(this.script.parentNode.removeChild(this.script),this.script=null);b.async=!0;b.src=this.uri();b.onerror=function(b){a.onError("jsonp poll error",
b)};var c=document.getElementsByTagName("script")[0];c?c.parentNode.insertBefore(b,c):(document.head||document.body).appendChild(b);this.script=b;"undefined"!==typeof navigator&&/gecko/i.test(navigator.userAgent)&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a);document.body.removeChild(a)},100)};d.prototype.doWrite=function(a,b){function c(){d();b()}function d(){if(f.iframe)try{f.form.removeChild(f.iframe)}catch(L){f.onError("jsonp polling iframe removal error",
L)}try{n=document.createElement('<iframe src="javascript:0" name="'+f.iframeId+'">')}catch(L){n=document.createElement("iframe"),n.name=f.iframeId,n.src="javascript:0"}n.id=f.iframeId;f.form.appendChild(n);f.iframe=n}var f=this;if(!this.form){var g=document.createElement("form"),k=document.createElement("textarea"),l=this.iframeId="eio_iframe_"+this.index,n;g.className="socketio";g.style.position="absolute";g.style.top="-1000px";g.style.left="-1000px";g.target=l;g.method="POST";g.setAttribute("accept-charset",
"utf-8");k.name="d";g.appendChild(k);document.body.appendChild(g);this.form=g;this.area=k}this.form.action=this.uri();d();a=a.replace(r,"\\\n");this.area.value=a.replace(h,"\\n");try{this.form.submit()}catch(L){}this.iframe.attachEvent?this.iframe.onreadystatechange=function(){"complete"===f.iframe.readyState&&c()}:this.iframe.onload=c}}).call(d,function(){return this}())},function(k,d,b){(function(c){function a(a){a&&a.forceBase64&&(this.supportsBinary=!1);this.perMessageDeflate=a.perMessageDeflate;
(this.usingBrowserWebSocket=q&&!a.forceNode)||(m=n);d.call(this,a)}var d=b(26),l=b(27),g=b(36),h=b(37),r=b(38),p=b(3)("engine.io-client:websocket"),q=c.WebSocket||c.MozWebSocket;if("undefined"===typeof window)try{var n=b(41)}catch(e){}var m=q;m||"undefined"!==typeof window||(m=n);k.exports=a;h(a,d);a.prototype.name="websocket";a.prototype.supportsBinary=!0;a.prototype.doOpen=function(){if(this.check()){var a=this.uri(),b={agent:this.agent,perMessageDeflate:this.perMessageDeflate};b.pfx=this.pfx;b.key=
this.key;b.passphrase=this.passphrase;b.cert=this.cert;b.ca=this.ca;b.ciphers=this.ciphers;b.rejectUnauthorized=this.rejectUnauthorized;this.extraHeaders&&(b.headers=this.extraHeaders);this.localAddress&&(b.localAddress=this.localAddress);try{this.ws=this.usingBrowserWebSocket?new m(a):new m(a,void 0,b)}catch(y){return this.emit("error",y)}void 0===this.ws.binaryType&&(this.supportsBinary=!1);this.ws.supports&&this.ws.supports.binary?(this.supportsBinary=!0,this.ws.binaryType="nodebuffer"):this.ws.binaryType=
"arraybuffer";this.addEventListeners()}};a.prototype.addEventListeners=function(){var a=this;this.ws.onopen=function(){a.onOpen()};this.ws.onclose=function(){a.onClose()};this.ws.onmessage=function(b){a.onData(b.data)};this.ws.onerror=function(b){a.onError("websocket error",b)}};a.prototype.write=function(a){function b(){d.emit("flush");setTimeout(function(){d.writable=!0;d.emit("drain")},0)}var d=this;this.writable=!1;for(var e=a.length,f=0,g=e;f<g;f++)(function(a){l.encodePacket(a,d.supportsBinary,
function(f){if(!d.usingBrowserWebSocket){var g={};a.options&&(g.compress=a.options.compress);d.perMessageDeflate&&("string"===typeof f?c.Buffer.byteLength(f):f.length)<d.perMessageDeflate.threshold&&(g.compress=!1)}try{d.usingBrowserWebSocket?d.ws.send(f):d.ws.send(f,g)}catch(X){p("websocket closed before onclose event")}--e||b()})})(a[f])};a.prototype.onClose=function(){d.prototype.onClose.call(this)};a.prototype.doClose=function(){"undefined"!==typeof this.ws&&this.ws.close()};a.prototype.uri=function(){var a=
this.query||{},b=this.secure?"wss":"ws",c="";this.port&&("wss"===b&&443!==Number(this.port)||"ws"===b&&80!==Number(this.port))&&(c=":"+this.port);this.timestampRequests&&(a[this.timestampParam]=r());this.supportsBinary||(a.b64=1);a=g.encode(a);a.length&&(a="?"+a);var d=-1!==this.hostname.indexOf(":");return b+"://"+(d?"["+this.hostname+"]":this.hostname)+c+this.path+a};a.prototype.check=function(){return!!m&&!("__initialize"in m&&this.name===a.prototype.name)}}).call(d,function(){return this}())},
function(k,d){},function(k,d){var b=[].indexOf;k.exports=function(c,a){if(b)return c.indexOf(a);for(var d=0;d<c.length;++d)if(c[d]===a)return d;return-1}},function(k,d){(function(b){var c=/^[\],:{}\s]*$/,a=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,d=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,l=/(?:^|:|,)(?:\s*\[)+/g,g=/^\s+/,h=/\s+$/;k.exports=function(f){if("string"!=typeof f||!f)return null;f=f.replace(g,"").replace(h,"");if(b.JSON&&JSON.parse)return JSON.parse(f);if(c.test(f.replace(a,
"@").replace(d,"]").replace(l,"")))return(new Function("return "+f))()}}).call(d,function(){return this}())},function(k,d,b){function c(a,b,c){this.io=a;this.nsp=b;this.json=this;this.ids=0;this.acks={};this.receiveBuffer=[];this.sendBuffer=[];this.connected=!1;this.disconnected=!0;c&&c.query&&(this.query=c.query);this.io.autoConnect&&this.open()}var a=b(7);d=b(35);var f=b(45),l=b(46),g=b(47),h=b(3)("socket.io-client:socket"),r=b(29);k.exports=c;var p={connect:1,connect_error:1,connect_timeout:1,
connecting:1,disconnect:1,error:1,reconnect:1,reconnect_attempt:1,reconnect_failed:1,reconnect_error:1,reconnecting:1,ping:1,pong:1},q=d.prototype.emit;d(c.prototype);c.prototype.subEvents=function(){if(!this.subs){var a=this.io;this.subs=[l(a,"open",g(this,"onopen")),l(a,"packet",g(this,"onpacket")),l(a,"close",g(this,"onclose"))]}};c.prototype.open=c.prototype.connect=function(){if(this.connected)return this;this.subEvents();this.io.open();if("open"===this.io.readyState)this.onopen();this.emit("connecting");
return this};c.prototype.send=function(){var a=f(arguments);a.unshift("message");this.emit.apply(this,a);return this};c.prototype.emit=function(b){if(p.hasOwnProperty(b))return q.apply(this,arguments),this;var c=f(arguments),d=a.EVENT;r(c)&&(d=a.BINARY_EVENT);d={type:d,data:c,options:{}};d.options.compress=!this.flags||!1!==this.flags.compress;"function"===typeof c[c.length-1]&&(h("emitting packet with ack id %d",this.ids),this.acks[this.ids]=c.pop(),d.id=this.ids++);this.connected?this.packet(d):
this.sendBuffer.push(d);delete this.flags;return this};c.prototype.packet=function(a){a.nsp=this.nsp;this.io.packet(a)};c.prototype.onopen=function(){h("transport is open - connecting");"/"!==this.nsp&&(this.query?this.packet({type:a.CONNECT,query:this.query}):this.packet({type:a.CONNECT}))};c.prototype.onclose=function(a){h("close (%s)",a);this.connected=!1;this.disconnected=!0;delete this.id;this.emit("disconnect",a)};c.prototype.onpacket=function(b){if(b.nsp===this.nsp)switch(b.type){case a.CONNECT:this.onconnect();
break;case a.EVENT:this.onevent(b);break;case a.BINARY_EVENT:this.onevent(b);break;case a.ACK:this.onack(b);break;case a.BINARY_ACK:this.onack(b);break;case a.DISCONNECT:this.ondisconnect();break;case a.ERROR:this.emit("error",b.data)}};c.prototype.onevent=function(a){var b=a.data||[];h("emitting event %j",b);null!=a.id&&(h("attaching ack callback to event"),b.push(this.ack(a.id)));this.connected?q.apply(this,b):this.receiveBuffer.push(b)};c.prototype.ack=function(b){var c=this,d=!1;return function(){if(!d){d=
!0;var e=f(arguments);h("sending ack %j",e);var g=r(e)?a.BINARY_ACK:a.ACK;c.packet({type:g,id:b,data:e})}}};c.prototype.onack=function(a){var b=this.acks[a.id];"function"===typeof b?(h("calling ack %s with %j",a.id,a.data),b.apply(this,a.data),delete this.acks[a.id]):h("bad ack %s",a.id)};c.prototype.onconnect=function(){this.connected=!0;this.disconnected=!1;this.emit("connect");this.emitBuffered()};c.prototype.emitBuffered=function(){var a;for(a=0;a<this.receiveBuffer.length;a++)q.apply(this,this.receiveBuffer[a]);
this.receiveBuffer=[];for(a=0;a<this.sendBuffer.length;a++)this.packet(this.sendBuffer[a]);this.sendBuffer=[]};c.prototype.ondisconnect=function(){h("server disconnect (%s)",this.nsp);this.destroy();this.onclose("io server disconnect")};c.prototype.destroy=function(){if(this.subs){for(var a=0;a<this.subs.length;a++)this.subs[a].destroy();this.subs=null}this.io.destroy(this)};c.prototype.close=c.prototype.disconnect=function(){this.connected&&(h("performing disconnect (%s)",this.nsp),this.packet({type:a.DISCONNECT}));
this.destroy();if(this.connected)this.onclose("io client disconnect");return this};c.prototype.compress=function(a){this.flags=this.flags||{};this.flags.compress=a;return this}},function(k,d){k.exports=function(b,c){for(var a=[],d=(c=c||0)||0;d<b.length;d++)a[d-c]=b[d];return a}},function(k,d){k.exports=function(b,c,a){b.on(c,a);return{destroy:function(){b.removeListener(c,a)}}}},function(k,d){var b=[].slice;k.exports=function(c,a){"string"==typeof a&&(a=c[a]);if("function"!=typeof a)throw Error("bind() requires a function");
var d=b.call(arguments,2);return function(){return a.apply(c,d.concat(b.call(arguments)))}}},function(k,d){function b(b){b=b||{};this.ms=b.min||100;this.max=b.max||1E4;this.factor=b.factor||2;this.jitter=0<b.jitter&&1>=b.jitter?b.jitter:0;this.attempts=0}k.exports=b;b.prototype.duration=function(){var b=this.ms*Math.pow(this.factor,this.attempts++);if(this.jitter){var a=Math.random(),d=Math.floor(a*this.jitter*b);b=0==(Math.floor(10*a)&1)?b-d:b+d}return Math.min(b,this.max)|0};b.prototype.reset=function(){this.attempts=
0};b.prototype.setMin=function(b){this.ms=b};b.prototype.setMax=function(b){this.max=b};b.prototype.setJitter=function(b){this.jitter=b}}])});var x,y,height,width,socket,playerDir={UP:87,DOWN:83,LEFT:65,RIGHT:68},playerSize=50,bulletSize=10,player={id:(new Date).getTime().toString(),score:0,quad:{tlx:0,tly:0,trx:0,"try":0,blx:0,bly:0,brx:0,bry:0},bullets:[],dir:playerDir.UP},enemies={},dead=!1,playersKilled=[],hasMoved=!1;
...
c=!1,console.log("killed player"))}c&&ellipse(a.x,a.y,bulletSize,bulletSize)})};